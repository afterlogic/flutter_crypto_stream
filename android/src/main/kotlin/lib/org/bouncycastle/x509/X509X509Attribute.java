...
public class X509X509Attribute
    extends ASN1Object
{
    lib.org.bouncycastle.asn1.x509.X509Attribute attr;
    ...
    X509X509Attribute(
        ASN1Encodable   at)
    {
        this.attr = lib.org.bouncycastle.asn1.x509.X509Attribute.getInstance(at);
    }
    ...
    public X509X509Attribute(
        ...
        ASN1Encodable   value)
    {
        this.attr = new lib.org.bouncycastle.asn1.x509.X509Attribute(new ASN1ObjectIdentifier(oid), new DERSet(value));
    }
