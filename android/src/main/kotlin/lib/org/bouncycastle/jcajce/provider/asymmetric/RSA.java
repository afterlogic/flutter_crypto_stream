...
import lib.org.bouncycastle.jcajce.provider.asymmetric.rsa.JcajceRsaKeyFactorySpi;
...
public class RSA
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".rsa.";
