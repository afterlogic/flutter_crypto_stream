...
import lib.org.bouncycastle.jcajce.provider.asymmetric.dstu.JcajceDstuKeyFactorySpi;
...
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".dstu.";
