...
import lib.org.bouncycastle.jcajce.provider.asymmetric.edec.JcajceEdecKeyFactorySpi;
...
public class EdEC
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".edec.";
