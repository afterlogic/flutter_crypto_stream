...
import lib.org.bouncycastle.jcajce.provider.util.jcaJceUtilDigestFactory;
    ...
    extends SignatureSpi
{
    ...
    private lib.org.bouncycastle.crypto.signers.PSSSigner pss;
        ...
        int trailerField)
    {
        if (trailerField == 1)
        {
            return lib.org.bouncycastle.crypto.signers.PSSSigner.TRAILER_IMPLICIT;
        }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new lib.org.bouncycastle.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength, trailer);
        pss.init(false, key);
        isInitState = true;
    }
