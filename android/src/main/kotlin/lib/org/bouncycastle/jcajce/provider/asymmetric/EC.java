...
import lib.org.bouncycastle.asn1.bsi.BSIObjectIdentifiers;
...
import lib.org.bouncycastle.jcajce.provider.asymmetric.ec.JcajceEcKeyFactorySpi;
...
public class EC
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".ec.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            if (!Properties.isOverrideSet("lib.org.bouncycastle.ec.disable_mqv"))
            {
