...
import lib.org.bouncycastle.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".gost.";
