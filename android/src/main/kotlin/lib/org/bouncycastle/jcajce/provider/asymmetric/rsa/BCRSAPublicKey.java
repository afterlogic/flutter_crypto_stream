    ...
    implements RSAPublicKey
{
    ...
    {
        return JcajceUtilKeyUtil.getEncodedSubjectPublicKeyInfo(algorithmIdentifier, new lib.org.bouncycastle.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
