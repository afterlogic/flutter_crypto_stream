package lib.org.bouncycastle.jcajce.provider.asymmetric.dstu;
...
import lib.org.bouncycastle.asn1.ua.DSTU4145BinaryField;
import lib.org.bouncycastle.asn1.ua.DSTU4145ECBinary;
import lib.org.bouncycastle.asn1.ua.DSTU4145NamedCurves;
import lib.org.bouncycastle.asn1.ua.DSTU4145Params;
import lib.org.bouncycastle.asn1.ua.DSTU4145PointEncoder;
import lib.org.bouncycastle.asn1.ua.UAObjectIdentifiers;
...
import lib.org.bouncycastle.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
    ...
    implements ECPrivateKey, JceECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    spec = new lib.org.bouncycastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
                }
        ...
        {
            lib.org.bouncycastle.asn1.sec.ECPrivateKey ec = lib.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        PrivateKeyInfo info;
        lib.org.bouncycastle.asn1.sec.ECPrivateKey keyStructure;

        if (publicKey != null)
        {
            keyStructure = new lib.org.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), publicKey, params);
        }
        else
        {
            keyStructure = new lib.org.bouncycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), params);
        }
