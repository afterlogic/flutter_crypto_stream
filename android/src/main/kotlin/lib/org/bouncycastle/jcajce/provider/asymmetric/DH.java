...
import lib.org.bouncycastle.jcajce.provider.asymmetric.dh.JcajceDhKeyFactorySpi;
...
public class DH
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".dh.";
