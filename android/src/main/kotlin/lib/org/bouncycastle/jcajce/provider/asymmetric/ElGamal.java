...
import lib.org.bouncycastle.jcajce.provider.asymmetric.elgamal.JcajceElgamalKeyFactorySpi;
...
{
    private static final String PREFIX = "lib.org.bouncycastle.jcajce.provider.asymmetric" + ".elgamal.";
