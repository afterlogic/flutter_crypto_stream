package lib.org.bouncycastle.jcajce.provider.keystore.bcfks;
...
import lib.org.bouncycastle.asn1.bc.EncryptedObjectStoreData;
import lib.org.bouncycastle.asn1.bc.EncryptedPrivateKeyData;
import lib.org.bouncycastle.asn1.bc.EncryptedSecretKeyData;
import lib.org.bouncycastle.asn1.bc.ObjectData;
import lib.org.bouncycastle.asn1.bc.ObjectDataSequence;
import lib.org.bouncycastle.asn1.bc.ObjectStore;
import lib.org.bouncycastle.asn1.bc.ObjectStoreData;
import lib.org.bouncycastle.asn1.bc.ObjectStoreIntegrityCheck;
import lib.org.bouncycastle.asn1.bc.PbkdMacIntegrityCheck;
import lib.org.bouncycastle.asn1.bc.SecretKeyData;
import lib.org.bouncycastle.asn1.bc.SignatureCheck;
import lib.org.bouncycastle.asn1.cms.CmsCCMParameters;
import lib.org.bouncycastle.asn1.kisa.KISAObjectIdentifiers;
import lib.org.bouncycastle.asn1.misc.MiscObjectIdentifiers;
import lib.org.bouncycastle.asn1.misc.ScryptParams;
import lib.org.bouncycastle.asn1.nist.NISTObjectIdentifiers;
import lib.org.bouncycastle.asn1.nsri.NSRIObjectIdentifiers;
import lib.org.bouncycastle.asn1.ntt.NTTObjectIdentifiers;
import lib.org.bouncycastle.asn1.oiw.OIWObjectIdentifiers;
import lib.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo;
import lib.org.bouncycastle.asn1.pkcs.EncryptionScheme;
import lib.org.bouncycastle.asn1.pkcs.KeyDerivationFunc;
import lib.org.bouncycastle.asn1.pkcs.PBES2Parameters;
...
import lib.org.bouncycastle.crypto.digests.SHA3Digest;
...
import lib.org.bouncycastle.crypto.util.PBKDF2Config;
import lib.org.bouncycastle.crypto.util.PBKDFConfig;
import lib.org.bouncycastle.crypto.util.ScryptConfig;
import lib.org.bouncycastle.jcajce.BCFKSLoadStoreParameter;
import lib.org.bouncycastle.jcajce.BCFKSStoreParameter;
import lib.org.bouncycastle.jcajce.BCLoadStoreParameter;
import lib.org.bouncycastle.jcajce.util.BCJcaJceHelper;
    ...
    extends KeyStoreSpi
{
    ...
    public Certificate[] engineGetCertificateChain(String alias)
    {
        ...
        if (ent != null)
        {
            ...
            {
                EncryptedPrivateKeyData encPrivData = EncryptedPrivateKeyData.getInstance(ent.getData());
                lib.org.bouncycastle.asn1.x509.X509Certificate[] certificates = encPrivData.getCertificateChain();
    ...
    private Certificate decodeCertificate(Object cert)
    {
        if (helper != null)
        {
            try
            {
                ...
                return certFact.generateCertificate(new ByteArrayInputStream(lib.org.bouncycastle.asn1.x509.X509Certificate.getInstance(cert).getEncoded()));
            }
            catch (Exception e)
            {
                return null;
    ...
    {
        lib.org.bouncycastle.asn1.x509.X509Certificate[] certChain = new lib.org.bouncycastle.asn1.x509.X509Certificate[chain.length];
        for (int i = 0; i != chain.length; i++)
        {
            certChain[i] = lib.org.bouncycastle.asn1.x509.X509Certificate.getInstance(chain[i].getEncoded());
        }
        ...
        else if (parameter instanceof BCFKSLoadStoreParameter)
        {
            ...
            if (bcParam.getStoreSignatureKey() != null)
            {
                ...
                try
                {
                    ...
                    if (certs != null)
                    {
                        lib.org.bouncycastle.asn1.x509.X509Certificate[] certificates = new lib.org.bouncycastle.asn1.x509.X509Certificate[certs.length];
                        for (int i = 0; i != certificates.length; i++)
                        {
                            certificates[i] = lib.org.bouncycastle.asn1.x509.X509Certificate.getInstance(certs[i].getEncoded());
                        }
        ...
        throws IOException, NoSuchAlgorithmException, CertificateException
    {
        ...
        else if (integrityCheck.getType() == ObjectStoreIntegrityCheck.SIG_CHECK)
        {
            ...
            try
            {
                lib.org.bouncycastle.asn1.x509.X509Certificate[] certificates = sigCheck.getCertificates();
                if (validator != null)
                {
