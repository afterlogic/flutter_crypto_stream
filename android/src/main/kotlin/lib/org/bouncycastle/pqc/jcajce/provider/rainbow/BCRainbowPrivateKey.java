...
import lib.org.bouncycastle.pqc.asn1.RainbowPrivateKey;
import lib.org.bouncycastle.pqc.crypto.rainbow.Layer;
import lib.org.bouncycastle.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import lib.org.bouncycastle.pqc.crypto.rainbow.util.RainbowUtil;
import lib.org.bouncycastle.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + lib.org.bouncycastle.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + lib.org.bouncycastle.util.Arrays.hashCode(b1);
        hash = hash * 37 + lib.org.bouncycastle.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + lib.org.bouncycastle.util.Arrays.hashCode(b2);
        hash = hash * 37 + lib.org.bouncycastle.util.Arrays.hashCode(vi);
