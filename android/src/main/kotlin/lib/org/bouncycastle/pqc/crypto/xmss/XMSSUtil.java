...
public class XMSSUtil
{
       ...
       extends ObjectInputStream
    {
        ...
        static
        {
            ...
            components.add("lib.org.bouncycastle.pqc.crypto.xmss.BDS");
            components.add("java.util.ArrayList");
            components.add("lib.org.bouncycastle.pqc.crypto.xmss.XMSSNode");
            components.add("[B");
            ...
            components.add("lib.org.bouncycastle.pqc.crypto.xmss.BDSTreeHash");
        }
