...
import lib.org.bouncycastle.openpgp.operator.jcajce.JcePBEDataDecryptorFactoryBuilder;
...
public class ByteArrayHandler
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("\nencrypted data = '"+new String(lib.org.bouncycastle.util.encoders.Hex.encode(encrypted))+"'");
