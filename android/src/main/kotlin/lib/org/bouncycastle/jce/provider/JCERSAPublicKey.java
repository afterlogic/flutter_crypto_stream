    ...
    implements RSAPublicKey
{
        ...
        SubjectPublicKeyInfo    info)
    {
        try
        {
            lib.org.bouncycastle.asn1.pkcs.RSAPublicKey   pubKey = lib.org.bouncycastle.asn1.pkcs.RSAPublicKey.getInstance(info.parsePublicKey());
    ...
    {
        return JcajceUtilKeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.rsaEncryption, DERNull.INSTANCE), new lib.org.bouncycastle.asn1.pkcs.RSAPublicKey(getModulus(), getPublicExponent()));
    }
