...
@interface LibOrgBouncycastleCryptoEnginesSEEDEngine () {
 @public
  IOSIntArray *wKey_;
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesSEEDEngine, wKey_, IOSIntArray *)

inline jint LibOrgBouncycastleCryptoEnginesSEEDEngine_get_BLOCK_SIZE(void);
#define LibOrgBouncycastleCryptoEnginesSEEDEngine_BLOCK_SIZE 16
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesSEEDEngine, BLOCK_SIZE, jint)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_get_SS0(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_SS0;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesSEEDEngine, SS0, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_get_SS1(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_SS1;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesSEEDEngine, SS1, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_get_SS2(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_SS2;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesSEEDEngine, SS2, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_get_SS3(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_SS3;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesSEEDEngine, SS3, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_get_KC(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_KC;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesSEEDEngine, KC, IOSIntArray *)

__attribute__((unused)) static IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_createWorkingKeyWithByteArray_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, IOSByteArray *inKey);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong lVal);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong lVal);

__attribute__((unused)) static jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateLeft8WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong x);

__attribute__((unused)) static jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateRight8WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong x);

__attribute__((unused)) static jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, IOSByteArray *src, jint srcOff);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesSEEDEngine_longToBytesWithByteArray_withInt_withLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, IOSByteArray *dest, jint destOff, jlong value);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint x);

__attribute__((unused)) static jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_FWithInt_withInt_withLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint ki0, jint ki1, jlong r);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc1WithInt_withInt_withInt_withInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint r0, jint ki0, jint r1, jint ki1);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc2WithInt_withInt_withInt_withInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint r0, jint ki0, jint r1, jint ki1);

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesSEEDEngine)

@implementation LibOrgBouncycastleCryptoEnginesSEEDEngine

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesSEEDEngine_init(self);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  ...
  wKey_ = LibOrgBouncycastleCryptoEnginesSEEDEngine_createWorkingKeyWithByteArray_(self, [((LibOrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((LibOrgBouncycastleCryptoParamsKeyParameter *) cast_chk(params, [LibOrgBouncycastleCryptoParamsKeyParameter class])))) getKey]);
}
...
- (jint)getBlockSize {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_BLOCK_SIZE;
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if (inOff + LibOrgBouncycastleCryptoEnginesSEEDEngine_BLOCK_SIZE > ((IOSByteArray *) nil_chk(inArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if (outOff + LibOrgBouncycastleCryptoEnginesSEEDEngine_BLOCK_SIZE > ((IOSByteArray *) nil_chk(outArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoOutputLengthException_initWithNSString_(@"output buffer too short");
  }
  jlong l = LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(self, inArg, inOff + 0);
  jlong r = LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(self, inArg, inOff + 8);
  if (forEncryption_) {
    for (jint i = 0; i < 16; i++) {
      jlong nl = r;
      r = l ^ LibOrgBouncycastleCryptoEnginesSEEDEngine_FWithInt_withInt_withLong_(self, IOSIntArray_Get(nil_chk(wKey_), 2 * i), IOSIntArray_Get(wKey_, (2 * i) + 1), r);
      l = nl;
    }
  }
  else {
  ...
  LibOrgBouncycastleCryptoEnginesSEEDEngine_longToBytesWithByteArray_withInt_withLong_(self, outArg, outOff + 0, r);
  LibOrgBouncycastleCryptoEnginesSEEDEngine_longToBytesWithByteArray_withInt_withLong_(self, outArg, outOff + 8, l);
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_BLOCK_SIZE;
}
...
- (IOSIntArray *)createWorkingKeyWithByteArray:(IOSByteArray *)inKey {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_createWorkingKeyWithByteArray_(self, inKey);
}

- (jint)extractW1WithLong:(jlong)lVal {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(self, lVal);
}

- (jint)extractW0WithLong:(jlong)lVal {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(self, lVal);
}

- (jlong)rotateLeft8WithLong:(jlong)x {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateLeft8WithLong_(self, x);
}

- (jlong)rotateRight8WithLong:(jlong)x {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateRight8WithLong_(self, x);
}

- (jlong)bytesToLongWithByteArray:(IOSByteArray *)src
                          withInt:(jint)srcOff {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(self, src, srcOff);
}

- (void)longToBytesWithByteArray:(IOSByteArray *)dest
                         withInt:(jint)destOff
                        withLong:(jlong)value {
  LibOrgBouncycastleCryptoEnginesSEEDEngine_longToBytesWithByteArray_withInt_withLong_(self, dest, destOff, value);
}

- (jint)GWithInt:(jint)x {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, x);
}

- (jlong)FWithInt:(jint)ki0
          withInt:(jint)ki1
         withLong:(jlong)r {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_FWithInt_withInt_withLong_(self, ki0, ki1, r);
}
...
- (jint)phaseCalc1WithInt:(jint)r0
                  ...
                  withInt:(jint)r1
                  withInt:(jint)ki1 {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc1WithInt_withInt_withInt_withInt_(self, r0, ki0, r1, ki1);
}
...
- (jint)phaseCalc2WithInt:(jint)r0
                  ...
                  withInt:(jint)r1
                  withInt:(jint)ki1 {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc2WithInt_withInt_withInt_withInt_(self, r0, ki0, r1, ki1);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "BLOCK_SIZE", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesSEEDEngine_BLOCK_SIZE, 0x12, 24, -1, -1, -1 },
...
+ (void)initialize {
  if (self == [LibOrgBouncycastleCryptoEnginesSEEDEngine class]) {
    ...
    J2OBJC_SET_INITIALIZED(LibOrgBouncycastleCryptoEnginesSEEDEngine)
  }
}

@end

void LibOrgBouncycastleCryptoEnginesSEEDEngine_init(LibOrgBouncycastleCryptoEnginesSEEDEngine *self) {
  NSObject_init(self);
}

LibOrgBouncycastleCryptoEnginesSEEDEngine *new_LibOrgBouncycastleCryptoEnginesSEEDEngine_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesSEEDEngine, init)
}

LibOrgBouncycastleCryptoEnginesSEEDEngine *create_LibOrgBouncycastleCryptoEnginesSEEDEngine_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesSEEDEngine, init)
}

IOSIntArray *LibOrgBouncycastleCryptoEnginesSEEDEngine_createWorkingKeyWithByteArray_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, IOSByteArray *inKey) {
  IOSIntArray *key = [IOSIntArray newArrayWithLength:32];
  jlong lower = LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(self, inKey, 0);
  jlong upper = LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(self, inKey, 8);
  jint key0 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(self, lower);
  jint key1 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(self, lower);
  jint key2 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(self, upper);
  jint key3 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(self, upper);
  for (jint i = 0; i < 16; i++) {
    *IOSIntArray_GetRef(key, 2 * i) = LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, key0 + key2 - IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSEEDEngine_KC), i));
    *IOSIntArray_GetRef(key, 2 * i + 1) = LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, key1 - key3 + IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesSEEDEngine_KC, i));
    if (i % 2 == 0) {
      lower = LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateRight8WithLong_(self, lower);
      key0 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(self, lower);
      key1 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(self, lower);
    }
    else {
      upper = LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateLeft8WithLong_(self, upper);
      key2 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(self, upper);
      key3 = LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(self, upper);
    }
  }
  return key;
}

jint LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW1WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong lVal) {
  return (jint) lVal;
}

jint LibOrgBouncycastleCryptoEnginesSEEDEngine_extractW0WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong lVal) {
  return (jint) (JreRShift64(lVal, 32));
}

jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateLeft8WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong x) {
  return (JreLShift64(x, 8)) | (JreURShift64(x, 56));
}

jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_rotateRight8WithLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jlong x) {
  return (JreURShift64(x, 8)) | (JreLShift64(x, 56));
}

jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_bytesToLongWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, IOSByteArray *src, jint srcOff) {
  jlong word = 0;
  for (jint i = 0; i <= 7; i++) {
...
void LibOrgBouncycastleCryptoEnginesSEEDEngine_longToBytesWithByteArray_withInt_withLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, IOSByteArray *dest, jint destOff, jlong value) {
  for (jint i = 0; i < 8; i++) {
    *IOSByteArray_GetRef(nil_chk(dest), i + destOff) = (jbyte) (JreRShift64(value, ((7 - i) * 8)));
  }
}

jint LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint x) {
  return IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSEEDEngine_SS0), x & (jint) 0xff) ^ IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSEEDEngine_SS1), (JreRShift32(x, 8)) & (jint) 0xff) ^ IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSEEDEngine_SS2), (JreRShift32(x, 16)) & (jint) 0xff) ^ IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSEEDEngine_SS3), (JreRShift32(x, 24)) & (jint) 0xff);
}

jlong LibOrgBouncycastleCryptoEnginesSEEDEngine_FWithInt_withInt_withLong_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint ki0, jint ki1, jlong r) {
  jint r0 = (jint) (JreRShift64(r, 32));
  jint r1 = (jint) r;
  jint rd1 = LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc2WithInt_withInt_withInt_withInt_(self, r0, ki0, r1, ki1);
  jint rd0 = rd1 + LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc1WithInt_withInt_withInt_withInt_(self, r0, ki0, r1, ki1);
  return (JreLShift64((jlong) rd0, 32)) | (rd1 & (jlong) 0xffffffffLL);
}

jint LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc1WithInt_withInt_withInt_withInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint r0, jint ki0, jint r1, jint ki1) {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, (r0 ^ ki0) ^ (r1 ^ ki1)) + (r0 ^ ki0));
}

jint LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc2WithInt_withInt_withInt_withInt_(LibOrgBouncycastleCryptoEnginesSEEDEngine *self, jint r0, jint ki0, jint r1, jint ki1) {
  return LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, LibOrgBouncycastleCryptoEnginesSEEDEngine_phaseCalc1WithInt_withInt_withInt_withInt_(self, r0, ki0, r1, ki1) + LibOrgBouncycastleCryptoEnginesSEEDEngine_GWithInt_(self, (r0 ^ ki0) ^ (r1 ^ ki1)));
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesSEEDEngine)
