...
@interface LibOrgBouncycastleCryptoEnginesAESFastEngine () {
 @public
  jint ROUNDS_;
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesAESFastEngine, WorkingKey_, IOSObjectArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_get_S(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_S;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesAESFastEngine, S, IOSByteArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_get_Si(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_Si;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesAESFastEngine, Si, IOSByteArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_get_rcon(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_rcon;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesAESFastEngine, rcon, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_get_T(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_T;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesAESFastEngine, T, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_get_Tinv(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesAESFastEngine, Tinv, IOSIntArray *)

inline jint LibOrgBouncycastleCryptoEnginesAESFastEngine_get_m1(void);
#define LibOrgBouncycastleCryptoEnginesAESFastEngine_m1 -2139062144
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesAESFastEngine, m1, jint)

inline jint LibOrgBouncycastleCryptoEnginesAESFastEngine_get_m2(void);
#define LibOrgBouncycastleCryptoEnginesAESFastEngine_m2 2139062143
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesAESFastEngine, m2, jint)

inline jint LibOrgBouncycastleCryptoEnginesAESFastEngine_get_m3(void);
#define LibOrgBouncycastleCryptoEnginesAESFastEngine_m3 27
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesAESFastEngine, m3, jint)

inline jint LibOrgBouncycastleCryptoEnginesAESFastEngine_get_m4(void);
#define LibOrgBouncycastleCryptoEnginesAESFastEngine_m4 -1061109568
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesAESFastEngine, m4, jint)

inline jint LibOrgBouncycastleCryptoEnginesAESFastEngine_get_m5(void);
#define LibOrgBouncycastleCryptoEnginesAESFastEngine_m5 1061109567
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesAESFastEngine, m5, jint)

inline jint LibOrgBouncycastleCryptoEnginesAESFastEngine_get_BLOCK_SIZE(void);
#define LibOrgBouncycastleCryptoEnginesAESFastEngine_BLOCK_SIZE 16
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesAESFastEngine, BLOCK_SIZE, jint)

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesAESFastEngine_shiftWithInt_withInt_(jint r, jint shift);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesAESFastEngine_FFmulXWithInt_(jint x);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesAESFastEngine_FFmulX2WithInt_(jint x);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesAESFastEngine_inv_mcolWithInt_(jint x);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(jint x);

__attribute__((unused)) static IOSObjectArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_generateWorkingKeyWithByteArray_withBoolean_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSByteArray *key, jboolean forEncryption);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesAESFastEngine_unpackBlockWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSByteArray *bytes, jint off);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesAESFastEngine_packBlockWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSByteArray *bytes, jint off);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesAESFastEngine_encryptBlockWithIntArray2_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSObjectArray *KW);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesAESFastEngine_decryptBlockWithIntArray2_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSObjectArray *KW);

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesAESFastEngine)

@implementation LibOrgBouncycastleCryptoEnginesAESFastEngine

+ (jint)shiftWithInt:(jint)r
             withInt:(jint)shift {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_shiftWithInt_withInt_(r, shift);
}

+ (jint)FFmulXWithInt:(jint)x {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_FFmulXWithInt_(x);
}

+ (jint)FFmulX2WithInt:(jint)x {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_FFmulX2WithInt_(x);
}

+ (jint)inv_mcolWithInt:(jint)x {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_inv_mcolWithInt_(x);
}

+ (jint)subWordWithInt:(jint)x {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(x);
}

- (IOSObjectArray *)generateWorkingKeyWithByteArray:(IOSByteArray *)key
                                        withBoolean:(jboolean)forEncryption {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_generateWorkingKeyWithByteArray_withBoolean_(self, key, forEncryption);
}

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesAESFastEngine_init(self);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  if ([params isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]]) {
    WorkingKey_ = LibOrgBouncycastleCryptoEnginesAESFastEngine_generateWorkingKeyWithByteArray_withBoolean_(self, [((LibOrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((LibOrgBouncycastleCryptoParamsKeyParameter *) params))) getKey], forEncryption);
...
- (jint)getBlockSize {
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_BLOCK_SIZE;
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  LibOrgBouncycastleCryptoEnginesAESFastEngine_unpackBlockWithByteArray_withInt_(self, inArg, inOff);
  if (forEncryption_) {
    LibOrgBouncycastleCryptoEnginesAESFastEngine_encryptBlockWithIntArray2_(self, WorkingKey_);
  }
  else {
    LibOrgBouncycastleCryptoEnginesAESFastEngine_decryptBlockWithIntArray2_(self, WorkingKey_);
  }
  LibOrgBouncycastleCryptoEnginesAESFastEngine_packBlockWithByteArray_withInt_(self, outArg, outOff);
  return LibOrgBouncycastleCryptoEnginesAESFastEngine_BLOCK_SIZE;
}
...
- (void)unpackBlockWithByteArray:(IOSByteArray *)bytes
                         withInt:(jint)off {
  LibOrgBouncycastleCryptoEnginesAESFastEngine_unpackBlockWithByteArray_withInt_(self, bytes, off);
}

- (void)packBlockWithByteArray:(IOSByteArray *)bytes
                       withInt:(jint)off {
  LibOrgBouncycastleCryptoEnginesAESFastEngine_packBlockWithByteArray_withInt_(self, bytes, off);
}

- (void)encryptBlockWithIntArray2:(IOSObjectArray *)KW {
  LibOrgBouncycastleCryptoEnginesAESFastEngine_encryptBlockWithIntArray2_(self, KW);
}

- (void)decryptBlockWithIntArray2:(IOSObjectArray *)KW {
  LibOrgBouncycastleCryptoEnginesAESFastEngine_decryptBlockWithIntArray2_(self, KW);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "m1", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesAESFastEngine_m1, 0x1a, -1, -1, -1, -1 },
    { "m2", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesAESFastEngine_m2, 0x1a, -1, -1, -1, -1 },
    { "m3", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesAESFastEngine_m3, 0x1a, -1, -1, -1, -1 },
    { "m4", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesAESFastEngine_m4, 0x1a, -1, -1, -1, -1 },
    { "m5", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesAESFastEngine_m5, 0x1a, -1, -1, -1, -1 },
...
IOSObjectArray *LibOrgBouncycastleCryptoEnginesAESFastEngine_generateWorkingKeyWithByteArray_withBoolean_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSByteArray *key, jboolean forEncryption) {
  ...
  switch (KC) {
    case 4:
    {
      ...
      *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, 0)), 3) = t3;
      for (jint i = 1; i <= 10; ++i) {
        jint u = LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine_shiftWithInt_withInt_(t3, 8)) ^ IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesAESFastEngine_rcon), i - 1);
        t0 ^= u;
    ...
    case 6:
    {
      ...
      *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, 1)), 1) = t5;
      jint rcon = 1;
      jint u = LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine_shiftWithInt_withInt_(t5, 8)) ^ rcon;
      ...
      *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, 2)), 3) = t5;
      for (jint i = 3; i < 12; i += 3) {
        u = LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine_shiftWithInt_withInt_(t5, 8)) ^ rcon;
        JreLShiftAssignInt(&rcon, 1);
        t0 ^= u;
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, i)), 0) = t0;
        t1 ^= t0;
    ...
    case 8:
    {
      ...
      *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, 1)), 3) = t7;
      ...
      for (jint i = 2; i < 14; i += 2) {
        u = LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine_shiftWithInt_withInt_(t7, 8)) ^ rcon;
        JreLShiftAssignInt(&rcon, 1);
        t0 ^= u;
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, i)), 0) = t0;
        t1 ^= t0;
        ...
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, i)), 2) = t2;
        t3 ^= t2;
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, i)), 3) = t3;
        u = LibOrgBouncycastleCryptoEnginesAESFastEngine_subWordWithInt_(t3);
        t4 ^= u;
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, i + 1)), 0) = t4;
        t5 ^= t4;
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, i + 1)), 1) = t5;
  ...
  if (!forEncryption) {
    for (jint j = 1; j < self->ROUNDS_; j++) {
      for (jint i = 0; i < 4; i++) {
        *IOSIntArray_GetRef(nil_chk(IOSObjectArray_Get(W, j)), i) = LibOrgBouncycastleCryptoEnginesAESFastEngine_inv_mcolWithInt_(IOSIntArray_Get(nil_chk(IOSObjectArray_Get(W, j)), i));
      }
    }
  }
  return W;
...
void LibOrgBouncycastleCryptoEnginesAESFastEngine_init(LibOrgBouncycastleCryptoEnginesAESFastEngine *self) {
  NSObject_init(self);
  self->WorkingKey_ = nil;
}

LibOrgBouncycastleCryptoEnginesAESFastEngine *new_LibOrgBouncycastleCryptoEnginesAESFastEngine_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesAESFastEngine, init)
}

LibOrgBouncycastleCryptoEnginesAESFastEngine *create_LibOrgBouncycastleCryptoEnginesAESFastEngine_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesAESFastEngine, init)
}

void LibOrgBouncycastleCryptoEnginesAESFastEngine_unpackBlockWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSByteArray *bytes, jint off) {
  self->C0_ = LibOrgBouncycastleUtilPack_littleEndianToIntWithByteArray_withInt_(bytes, off);
  self->C1_ = LibOrgBouncycastleUtilPack_littleEndianToIntWithByteArray_withInt_(bytes, off + 4);
  self->C2_ = LibOrgBouncycastleUtilPack_littleEndianToIntWithByteArray_withInt_(bytes, off + 8);
  self->C3_ = LibOrgBouncycastleUtilPack_littleEndianToIntWithByteArray_withInt_(bytes, off + 12);
}

void LibOrgBouncycastleCryptoEnginesAESFastEngine_packBlockWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSByteArray *bytes, jint off) {
  LibOrgBouncycastleUtilPack_intToLittleEndianWithInt_withByteArray_withInt_(self->C0_, bytes, off);
  LibOrgBouncycastleUtilPack_intToLittleEndianWithInt_withByteArray_withInt_(self->C1_, bytes, off + 4);
  LibOrgBouncycastleUtilPack_intToLittleEndianWithInt_withByteArray_withInt_(self->C2_, bytes, off + 8);
  LibOrgBouncycastleUtilPack_intToLittleEndianWithInt_withByteArray_withInt_(self->C3_, bytes, off + 12);
}

void LibOrgBouncycastleCryptoEnginesAESFastEngine_encryptBlockWithIntArray2_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSObjectArray *KW) {
  ...
  while (r < self->ROUNDS_ - 1) {
    ...
    i2 &= 255;
    i3 &= 255;
    r0 = IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesAESFastEngine_T), i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 0);
    i0 = t1;
    ...
    i2 &= 255;
    i3 &= 255;
    r1 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 1);
    i0 = t2;
    ...
    i2 &= 255;
    i3 &= 255;
    r2 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 2);
    i0 = r3;
    ...
    i2 &= 255;
    i3 &= 255;
    r3 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r++)), 3);
    i0 = r0;
    ...
    i2 &= 255;
    i3 &= 255;
    t0 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 0);
    i0 = r1;
    ...
    i2 &= 255;
    i3 &= 255;
    t1 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 1);
    i0 = r2;
    i1 = JreURShift32(r3, 8);
    ...
    i2 &= 255;
    i3 &= 255;
    t2 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_T, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 2);
    i0 = r3;
  ...
  i2 = JreURShift32(r3, 16);
  i3 = JreURShift32(r0, 24);
  i0 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_S, i0 & 255) & 255;
  i1 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_S, i1 & 255) & 255;
  i2 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_S, i2 & 255) & 255;
  i3 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_S, i3 & 255) & 255;
...
void LibOrgBouncycastleCryptoEnginesAESFastEngine_decryptBlockWithIntArray2_(LibOrgBouncycastleCryptoEnginesAESFastEngine *self, IOSObjectArray *KW) {
  ...
  while (r > 1) {
    ...
    i2 &= 255;
    i3 &= 255;
    r0 = IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv), i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 0);
    i0 = t1;
    i1 = JreURShift32(t0, 8);
    i2 = JreURShift32(r3, 16);
    i3 = JreURShift32(t2, 24);
    ...
    i2 &= 255;
    i3 &= 255;
    r1 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 1);
    i0 = t2;
    i1 = JreURShift32(t1, 8);
    i2 = JreURShift32(t0, 16);
    i3 = JreURShift32(r3, 24);
    ...
    i2 &= 255;
    i3 &= 255;
    r2 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 2);
    i0 = r3;
    i1 = JreURShift32(t2, 8);
    i2 = JreURShift32(t1, 16);
    i3 = JreURShift32(t0, 24);
    ...
    i2 &= 255;
    i3 &= 255;
    r3 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r--)), 3);
    i0 = r0;
    i1 = JreURShift32(r3, 8);
    i2 = JreURShift32(r2, 16);
    i3 = JreURShift32(r1, 24);
    ...
    i2 &= 255;
    i3 &= 255;
    t0 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 0);
    i0 = r1;
    i1 = JreURShift32(r0, 8);
    i2 = JreURShift32(r3, 16);
    i3 = JreURShift32(r2, 24);
    ...
    i2 &= 255;
    i3 &= 255;
    t1 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 1);
    i0 = r2;
    i1 = JreURShift32(r1, 8);
    i2 = JreURShift32(r0, 16);
    i3 = JreURShift32(r3, 24);
    ...
    i2 &= 255;
    i3 &= 255;
    t2 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, r)), 2);
    i0 = r3;
    i1 = JreURShift32(r2, 8);
    i2 = JreURShift32(r1, 16);
    i3 = JreURShift32(r0, 24);
  ...
  i2 &= 255;
  i3 &= 255;
  r0 = IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv), i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, 1)), 0);
  i0 = t1;
  i1 = JreURShift32(t0, 8);
  i2 = JreURShift32(r3, 16);
  i3 = JreURShift32(t2, 24);
  ...
  i2 &= 255;
  i3 &= 255;
  r1 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, 1)), 1);
  i0 = t2;
  i1 = JreURShift32(t1, 8);
  i2 = JreURShift32(t0, 16);
  i3 = JreURShift32(r3, 24);
  ...
  i2 &= 255;
  i3 &= 255;
  r2 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, 1)), 2);
  i0 = r3;
  i1 = JreURShift32(t2, 8);
  i2 = JreURShift32(t1, 16);
  i3 = JreURShift32(t0, 24);
  ...
  i2 &= 255;
  i3 &= 255;
  r3 = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, i0) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 256 + i1) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 512 + i2) ^ IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Tinv, 768 + i3) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, 1)), 3);
  i0 = r0;
  i1 = JreURShift32(r3, 8);
  i2 = JreURShift32(r2, 16);
  i3 = JreURShift32(r1, 24);
  i0 = IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si), i0 & 255) & 255;
  i1 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i1 & 255) & 255;
  i2 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i2 & 255) & 255;
  i3 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i3 & 255) & 255;
  self->C0_ = i0 ^ JreLShift32(i1, 8) ^ JreLShift32(i2, 16) ^ JreLShift32(i3, 24) ^ IOSIntArray_Get(nil_chk(IOSObjectArray_Get(KW, 0)), 0);
  i0 = r1;
  i1 = JreURShift32(r0, 8);
  i2 = JreURShift32(r3, 16);
  i3 = JreURShift32(r2, 24);
  i0 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i0 & 255) & 255;
  i1 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i1 & 255) & 255;
  i2 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i2 & 255) & 255;
  i3 = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesAESFastEngine_Si, i3 & 255) & 255;
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesAESFastEngine)
