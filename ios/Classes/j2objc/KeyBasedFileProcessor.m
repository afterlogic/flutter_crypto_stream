...
#include "KeyBasedFileProcessor.h"
...
@interface LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor ()
...
__attribute__((unused)) static void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithNSString_withNSString_withCharArray_withNSString_(NSString *inputFileName, NSString *keyFileName, IOSCharArray *passwd, NSString *defaultFileName);

__attribute__((unused)) static void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithJavaIoInputStream_withJavaIoInputStream_withCharArray_withNSString_(JavaIoInputStream *inArg, JavaIoInputStream *keyIn, IOSCharArray *passwd, NSString *defaultFileName);

__attribute__((unused)) static void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithNSString_withNSString_withNSString_withBoolean_withBoolean_(NSString *outputFileName, NSString *inputFileName, NSString *encKeyFileName, jboolean armor, jboolean withIntegrityCheck);

__attribute__((unused)) static void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithJavaIoOutputStream_withNSString_withLibOrgBouncycastleOpenpgpPGPPublicKey_withBoolean_withBoolean_(JavaIoOutputStream *outArg, NSString *fileName, LibOrgBouncycastleOpenpgpPGPPublicKey *encKey, jboolean armor, jboolean withIntegrityCheck);

@implementation LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_init(self);
  return self;
}
...
+ (void)decryptFileWithNSString:(NSString *)inputFileName
                  ...
                  withCharArray:(IOSCharArray *)passwd
                   withNSString:(NSString *)defaultFileName {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithNSString_withNSString_withCharArray_withNSString_(inputFileName, keyFileName, passwd, defaultFileName);
}
...
+ (void)decryptFileWithJavaIoInputStream:(JavaIoInputStream *)inArg
                   withJavaIoInputStream:(JavaIoInputStream *)keyIn
                           withCharArray:(IOSCharArray *)passwd
                            withNSString:(NSString *)defaultFileName {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithJavaIoInputStream_withJavaIoInputStream_withCharArray_withNSString_(inArg, keyIn, passwd, defaultFileName);
}
...
+ (void)encryptFileWithNSString:(NSString *)outputFileName
                   ...
                   withNSString:(NSString *)encKeyFileName
                    withBoolean:(jboolean)armor
                    withBoolean:(jboolean)withIntegrityCheck {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithNSString_withNSString_withNSString_withBoolean_withBoolean_(outputFileName, inputFileName, encKeyFileName, armor, withIntegrityCheck);
}
...
withLibOrgBouncycastleOpenpgpPGPPublicKey:(LibOrgBouncycastleOpenpgpPGPPublicKey *)encKey
                              withBoolean:(jboolean)armor
                              withBoolean:(jboolean)withIntegrityCheck {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithJavaIoOutputStream_withNSString_withLibOrgBouncycastleOpenpgpPGPPublicKey_withBoolean_withBoolean_(outArg, fileName, encKey, armor, withIntegrityCheck);
}

+ (void)mainWithNSStringArray:(IOSObjectArray *)args {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_mainWithNSStringArray_(args);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor = { "KeyBasedFileProcessor", "lib.org.bouncycastle.openpgp.examples", ptrTable, methods, NULL, 7, 0x1, 6, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor;
}

@end

void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_init(LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor *self) {
  NSObject_init(self);
}

LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor *new_LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor, init)
}

LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor *create_LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor, init)
}

void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithNSString_withNSString_withCharArray_withNSString_(NSString *inputFileName, NSString *keyFileName, IOSCharArray *passwd, NSString *defaultFileName) {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_initialize();
  ...
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithJavaIoInputStream_withJavaIoInputStream_withCharArray_withNSString_(in, keyIn, passwd, defaultFileName);
  [keyIn close];
  [in close];
}

void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithJavaIoInputStream_withJavaIoInputStream_withCharArray_withNSString_(JavaIoInputStream *inArg, JavaIoInputStream *keyIn, IOSCharArray *passwd, NSString *defaultFileName) {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_initialize();
  ...
  @try {
    ...
    id message = [plainFact nextObject];
    if ([message isKindOfClass:[LibOrgBouncycastleOpenpgpPGPCompressedData class]]) {
      LibOrgBouncycastleOpenpgpPGPCompressedData *cData = (LibOrgBouncycastleOpenpgpPGPCompressedData *) message;
      LibOrgBouncycastleOpenpgpJcajceJcaPGPObjectFactory *pgpFact = new_LibOrgBouncycastleOpenpgpJcajceJcaPGPObjectFactory_initWithJavaIoInputStream_([((LibOrgBouncycastleOpenpgpPGPCompressedData *) nil_chk(cData)) getDataStream]);
...
void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithNSString_withNSString_withNSString_withBoolean_withBoolean_(NSString *outputFileName, NSString *inputFileName, NSString *encKeyFileName, jboolean armor, jboolean withIntegrityCheck) {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_initialize();
  ...
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithJavaIoOutputStream_withNSString_withLibOrgBouncycastleOpenpgpPGPPublicKey_withBoolean_withBoolean_(out, inputFileName, encKey, armor, withIntegrityCheck);
  [out close];
}
...
void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithJavaIoOutputStream_withNSString_withLibOrgBouncycastleOpenpgpPGPPublicKey_withBoolean_withBoolean_(JavaIoOutputStream *outArg, NSString *fileName, LibOrgBouncycastleOpenpgpPGPPublicKey *encKey, jboolean armor, jboolean withIntegrityCheck) {
  ...
  @try {
    IOSByteArray *bytes = LibOrgBouncycastleOpenpgpExamplesPGPExampleUtil_compressFileWithNSString_withInt_(fileName, LibOrgBouncycastleBcpgCompressionAlgorithmTags_ZIP);
    ...
    [encGen addMethodWithLibOrgBouncycastleOpenpgpOperatorPGPKeyEncryptionMethodGenerator:[new_LibOrgBouncycastleOpenpgpOperatorJcajceJcePublicKeyKeyEncryptionMethodGenerator_initWithLibOrgBouncycastleOpenpgpPGPPublicKey_(encKey) setProviderWithNSString:@"BC"]];
    JavaIoOutputStream *cOut = [encGen openWithJavaIoOutputStream:outArg withLong:((IOSByteArray *) nil_chk(bytes))->size_];
    [((JavaIoOutputStream *) nil_chk(cOut)) writeWithByteArray:bytes];
    [cOut close];
    if (armor) {
...
void LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_mainWithNSStringArray_(IOSObjectArray *args) {
  LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_initialize();
  ...
  if (((IOSObjectArray *) nil_chk(args))->size_ == 0) {
    [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, err))) printlnWithNSString:@"usage: KeyBasedFileProcessor -e|-d [-a|ai] file [secretKeyFile passPhrase|pubKeyFile]"];
    return;
  }
  if ([((NSString *) nil_chk(IOSObjectArray_Get(args, 0))) isEqual:@"-e"]) {
    if ([((NSString *) nil_chk(IOSObjectArray_Get(args, 1))) isEqual:@"-a"] || [((NSString *) nil_chk(IOSObjectArray_Get(args, 1))) isEqual:@"-ai"] || [((NSString *) nil_chk(IOSObjectArray_Get(args, 1))) isEqual:@"-ia"]) {
      LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithNSString_withNSString_withNSString_withBoolean_withBoolean_(JreStrcat("$$", IOSObjectArray_Get(args, 2), @".asc"), IOSObjectArray_Get(args, 2), IOSObjectArray_Get(args, 3), true, ([((NSString *) nil_chk(IOSObjectArray_Get(args, 1))) java_indexOf:'i'] > 0));
    }
    else if ([((NSString *) nil_chk(IOSObjectArray_Get(args, 1))) isEqual:@"-i"]) {
      LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithNSString_withNSString_withNSString_withBoolean_withBoolean_(JreStrcat("$$", IOSObjectArray_Get(args, 2), @".bpg"), IOSObjectArray_Get(args, 2), IOSObjectArray_Get(args, 3), false, true);
    }
    else {
      LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_encryptFileWithNSString_withNSString_withNSString_withBoolean_withBoolean_(JreStrcat("$$", IOSObjectArray_Get(args, 1), @".bpg"), IOSObjectArray_Get(args, 1), IOSObjectArray_Get(args, 2), false, false);
    }
  }
  else if ([((NSString *) nil_chk(IOSObjectArray_Get(args, 0))) isEqual:@"-d"]) {
    LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor_decryptFileWithNSString_withNSString_withCharArray_withNSString_(IOSObjectArray_Get(args, 1), IOSObjectArray_Get(args, 2), [((NSString *) nil_chk(IOSObjectArray_Get(args, 3))) java_toCharArray], JreStrcat("$$", [new_JavaIoFile_initWithNSString_(IOSObjectArray_Get(args, 1)) getName], @".out"));
  }
  else {
    [((JavaIoPrintStream *) nil_chk(JreLoadStatic(JavaLangSystem, err))) printlnWithNSString:@"usage: KeyBasedFileProcessor -d|-e [-a|ai] file [secretKeyFile passPhrase|pubKeyFile]"];
  }
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleOpenpgpExamplesKeyBasedFileProcessor)
