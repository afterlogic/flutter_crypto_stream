...
@implementation LibOrgBouncycastleCryptoEnginesChaCha7539Engine

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesChaCha7539Engine_init(self);
  return self;
}
...
- (void)setKeyWithByteArray:(IOSByteArray *)keyBytes
  ...
  if (keyBytes != nil) {
    ...
    LibOrgBouncycastleUtilPack_littleEndianToIntWithByteArray_withInt_withIntArray_withInt_withInt_(keyBytes, 0, engineState_, 4, 8);
  }
  LibOrgBouncycastleUtilPack_littleEndianToIntWithByteArray_withInt_withIntArray_withInt_withInt_(ivBytes, 0, engineState_, 13, 3);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoEnginesChaCha7539Engine = { "ChaCha7539Engine", "lib.org.bouncycastle.crypto.engines", ptrTable, methods, NULL, 7, 0x1, 11, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoEnginesChaCha7539Engine;
}

@end

void LibOrgBouncycastleCryptoEnginesChaCha7539Engine_init(LibOrgBouncycastleCryptoEnginesChaCha7539Engine *self) {
  LibOrgBouncycastleCryptoEnginesSalsa20Engine_init(self);
}

LibOrgBouncycastleCryptoEnginesChaCha7539Engine *new_LibOrgBouncycastleCryptoEnginesChaCha7539Engine_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesChaCha7539Engine, init)
}

LibOrgBouncycastleCryptoEnginesChaCha7539Engine *create_LibOrgBouncycastleCryptoEnginesChaCha7539Engine_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesChaCha7539Engine, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesChaCha7539Engine)
