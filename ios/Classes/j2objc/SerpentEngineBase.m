...
@implementation LibOrgBouncycastleCryptoEnginesSerpentEngineBase

+ (jint)BLOCK_SIZE {
  return LibOrgBouncycastleCryptoEnginesSerpentEngineBase_BLOCK_SIZE;
}

+ (jint)ROUNDS {
  return LibOrgBouncycastleCryptoEnginesSerpentEngineBase_ROUNDS;
}

+ (jint)PHI {
  return LibOrgBouncycastleCryptoEnginesSerpentEngineBase_PHI;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  if ([params isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]]) {
    ...
    self->wKey_ = [self makeWorkingKeyWithByteArray:[((LibOrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((LibOrgBouncycastleCryptoParamsKeyParameter *) params))) getKey]];
    return;
  }
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if ((inOff + LibOrgBouncycastleCryptoEnginesSerpentEngineBase_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(inArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if ((outOff + LibOrgBouncycastleCryptoEnginesSerpentEngineBase_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(outArg))->size_) {
...
+ (jint)rotateLeftWithInt:(jint)x
                  withInt:(jint)bits {
  return LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(x, bits);
}

+ (jint)rotateRightWithInt:(jint)x
                   withInt:(jint)bits {
  return LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(x, bits);
}
...
- (void)LT {
  jint x0 = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(X0_, 13);
  jint x2 = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(X2_, 3);
  jint x1 = X1_ ^ x0 ^ x2;
  jint x3 = X3_ ^ x2 ^ JreLShift32(x0, 3);
  X1_ = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(x1, 1);
  X3_ = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(x3, 7);
  X0_ = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(x0 ^ X1_ ^ X3_, 5);
  X2_ = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(x2 ^ X3_ ^ (JreLShift32(X1_, 7)), 22);
}

- (void)inverseLT {
  jint x2 = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(X2_, 22) ^ X3_ ^ (JreLShift32(X1_, 7));
  jint x0 = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(X0_, 5) ^ X1_ ^ X3_;
  jint x3 = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(X3_, 7);
  jint x1 = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(X1_, 1);
  X3_ = x3 ^ x2 ^ JreLShift32(x0, 3);
  X1_ = x1 ^ x0 ^ x2;
  X2_ = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(x2, 3);
  X0_ = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(x0, 13);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "BLOCK_SIZE", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_BLOCK_SIZE, 0x1c, -1, -1, -1, -1 },
    { "ROUNDS", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_ROUNDS, 0x18, -1, -1, -1, -1 },
    { "PHI", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesSerpentEngineBase_PHI, 0x18, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "init", "ZLLibOrgBouncycastleCryptoCipherParameters;", "processBlock", "[BI[BI", "rotateLeft", "II", "rotateRight", "sb0", "IIII", "ib0", "sb1", "ib1", "sb2", "ib2", "sb3", "ib3", "sb4", "ib4", "sb5", "ib5", "sb6", "ib6", "sb7", "ib7", "makeWorkingKey", "[B", "encryptBlock", "decryptBlock" };
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoEnginesSerpentEngineBase = { "SerpentEngineBase", "lib.org.bouncycastle.crypto.engines", ptrTable, methods, fields, 7, 0x401, 29, 9, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoEnginesSerpentEngineBase;
}

@end

void LibOrgBouncycastleCryptoEnginesSerpentEngineBase_init(LibOrgBouncycastleCryptoEnginesSerpentEngineBase *self) {
  NSObject_init(self);
}

jint LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateLeftWithInt_withInt_(jint x, jint bits) {
  LibOrgBouncycastleCryptoEnginesSerpentEngineBase_initialize();
  return (JreLShift32(x, bits)) | (JreURShift32(x, -bits));
}

jint LibOrgBouncycastleCryptoEnginesSerpentEngineBase_rotateRightWithInt_withInt_(jint x, jint bits) {
  LibOrgBouncycastleCryptoEnginesSerpentEngineBase_initialize();
  return (JreURShift32(x, bits)) | (JreLShift32(x, -bits));
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesSerpentEngineBase)
