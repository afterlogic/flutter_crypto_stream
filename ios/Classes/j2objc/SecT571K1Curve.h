...
#ifndef SecT571K1Curve_H
#define SecT571K1Curve_H
...
@class LibOrgBouncycastleMathEcCustomSecSecT571K1Point;
...
@interface LibOrgBouncycastleMathEcCustomSecSecT571K1Curve : LibOrgBouncycastleMathEcECCurve_AbstractF2m {
 @public
  LibOrgBouncycastleMathEcCustomSecSecT571K1Point *infinity_;
}
...
J2OBJC_EMPTY_STATIC_INIT(LibOrgBouncycastleMathEcCustomSecSecT571K1Curve)

J2OBJC_FIELD_SETTER(LibOrgBouncycastleMathEcCustomSecSecT571K1Curve, infinity_, LibOrgBouncycastleMathEcCustomSecSecT571K1Point *)

FOUNDATION_EXPORT void LibOrgBouncycastleMathEcCustomSecSecT571K1Curve_init(LibOrgBouncycastleMathEcCustomSecSecT571K1Curve *self);

FOUNDATION_EXPORT LibOrgBouncycastleMathEcCustomSecSecT571K1Curve *new_LibOrgBouncycastleMathEcCustomSecSecT571K1Curve_init(void) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT LibOrgBouncycastleMathEcCustomSecSecT571K1Curve *create_LibOrgBouncycastleMathEcCustomSecSecT571K1Curve_init(void);

J2OBJC_TYPE_LITERAL_HEADER(LibOrgBouncycastleMathEcCustomSecSecT571K1Curve)


#if __has_feature(nullability)
#pragma clang diagnostic pop
#endif
#endif // SecT571K1Curve_H
