...
@implementation LibOrgBouncycastleCryptoEnginesTnepresEngine

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesTnepresEngine_init(self);
  return self;
}
...
- (IOSIntArray *)makeWorkingKeyWithByteArray:(IOSByteArray *)key {
  ...
  jint off = 0;
  jint length = 0;
  for (off = ((IOSByteArray *) nil_chk(key))->size_ - 4; off > 0; off -= 4) {
    *IOSIntArray_GetRef(kPad, length++) = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(key, off);
  }
  if (off == 0) {
    *IOSIntArray_GetRef(kPad, length++) = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(key, 0);
    if (length < 8) {
...
- (void)encryptBlockWithByteArray:(IOSByteArray *)input
                    ...
                    withByteArray:(IOSByteArray *)output
                          withInt:(jint)outOff {
  X3_ = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff);
  X2_ = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 4);
  X1_ = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 8);
  X0_ = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 12);
  ...
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 131) ^ X3_, output, outOff);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 130) ^ X2_, output, outOff + 4);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 129) ^ X1_, output, outOff + 8);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(IOSIntArray_Get(nil_chk(wKey_), 128) ^ X0_, output, outOff + 12);
}
...
- (void)decryptBlockWithByteArray:(IOSByteArray *)input
                    ...
                    withByteArray:(IOSByteArray *)output
                          withInt:(jint)outOff {
  X3_ = IOSIntArray_Get(nil_chk(wKey_), 131) ^ LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff);
  X2_ = IOSIntArray_Get(nil_chk(wKey_), 130) ^ LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 4);
  X1_ = IOSIntArray_Get(nil_chk(wKey_), 129) ^ LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 8);
  X0_ = IOSIntArray_Get(nil_chk(wKey_), 128) ^ LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(input, inOff + 12);
  ...
  [self inverseLT];
  [self ib0WithInt:X0_ withInt:X1_ withInt:X2_ withInt:X3_];
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X3_ ^ IOSIntArray_Get(nil_chk(wKey_), 3), output, outOff);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X2_ ^ IOSIntArray_Get(nil_chk(wKey_), 2), output, outOff + 4);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X1_ ^ IOSIntArray_Get(nil_chk(wKey_), 1), output, outOff + 8);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(X0_ ^ IOSIntArray_Get(nil_chk(wKey_), 0), output, outOff + 12);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[2].selector = @selector(makeWorkingKeyWithByteArray:);
  methods[3].selector = @selector(encryptBlockWithByteArray:withInt:withByteArray:withInt:);
  methods[4].selector = @selector(decryptBlockWithByteArray:withInt:withByteArray:withInt:);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "makeWorkingKey", "[B", "LJavaLangIllegalArgumentException;", "encryptBlock", "[BI[BI", "decryptBlock" };
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoEnginesTnepresEngine = { "TnepresEngine", "lib.org.bouncycastle.crypto.engines", ptrTable, methods, NULL, 7, 0x11, 5, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoEnginesTnepresEngine;
}

@end

void LibOrgBouncycastleCryptoEnginesTnepresEngine_init(LibOrgBouncycastleCryptoEnginesTnepresEngine *self) {
  LibOrgBouncycastleCryptoEnginesSerpentEngineBase_init(self);
}

LibOrgBouncycastleCryptoEnginesTnepresEngine *new_LibOrgBouncycastleCryptoEnginesTnepresEngine_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesTnepresEngine, init)
}

LibOrgBouncycastleCryptoEnginesTnepresEngine *create_LibOrgBouncycastleCryptoEnginesTnepresEngine_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesTnepresEngine, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesTnepresEngine)
