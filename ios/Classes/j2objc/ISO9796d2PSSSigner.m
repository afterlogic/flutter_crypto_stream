...
@interface LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, digest_, id<LibOrgBouncycastleCryptoDigest>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, cipher_, id<LibOrgBouncycastleCryptoAsymmetricBlockCipher>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, random_, JavaSecuritySecureRandom *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, standardSalt_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, block_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, mBuf_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, recoveredMessage_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, preSig_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, preBlock_, IOSByteArray *)

__attribute__((unused)) static jboolean LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_isSameAsWithByteArray_withByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, IOSByteArray *a, IOSByteArray *b);

__attribute__((unused)) static void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, IOSByteArray *block);

__attribute__((unused)) static void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_ItoOSPWithInt_withByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, jint i, IOSByteArray *sp);

__attribute__((unused)) static void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_LtoOSPWithLong_withByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, jlong l, IOSByteArray *sp);

__attribute__((unused)) static IOSByteArray *LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_maskGeneratorFunction1WithByteArray_withInt_withInt_withInt_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, IOSByteArray *Z, jint zOff, jint zLen, jint length);

@implementation LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner

+ (jint)TRAILER_IMPLICIT {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_IMPLICIT;
}

+ (jint)TRAILER_RIPEMD160 {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_RIPEMD160;
}

+ (jint)TRAILER_RIPEMD128 {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_RIPEMD128;
}

+ (jint)TRAILER_SHA1 {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA1;
}

+ (jint)TRAILER_SHA256 {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA256;
}

+ (jint)TRAILER_SHA512 {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA512;
}

+ (jint)TRAILER_SHA384 {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA384;
}

+ (jint)TRAILER_WHIRLPOOL {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_WHIRLPOOL;
}
...
- (instancetype)initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher:(id<LibOrgBouncycastleCryptoAsymmetricBlockCipher>)cipher
  ...
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_withBoolean_(self, cipher, digest, saltLength, implicit);
  return self;
}
...
- (instancetype)initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher:(id<LibOrgBouncycastleCryptoAsymmetricBlockCipher>)cipher
                                   withLibOrgBouncycastleCryptoDigest:(id<LibOrgBouncycastleCryptoDigest>)digest
                                                              withInt:(jint)saltLength {
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_(self, cipher, digest, saltLength);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)param {
  ...
  if ([param isKindOfClass:[LibOrgBouncycastleCryptoParamsParametersWithRandom class]]) {
    ...
    kParam = (LibOrgBouncycastleCryptoParamsRSAKeyParameters *) cast_chk([((LibOrgBouncycastleCryptoParamsParametersWithRandom *) nil_chk(p)) getParameters], [LibOrgBouncycastleCryptoParamsRSAKeyParameters class]);
    if (forSigning) {
      random_ = [p getRandom];
    }
  }
  else if ([param isKindOfClass:[LibOrgBouncycastleCryptoParamsParametersWithSalt class]]) {
    LibOrgBouncycastleCryptoParamsParametersWithSalt *p = (LibOrgBouncycastleCryptoParamsParametersWithSalt *) param;
    kParam = (LibOrgBouncycastleCryptoParamsRSAKeyParameters *) cast_chk([((LibOrgBouncycastleCryptoParamsParametersWithSalt *) nil_chk(p)) getParameters], [LibOrgBouncycastleCryptoParamsRSAKeyParameters class]);
  ...
  if (trailer_ == LibOrgBouncycastleCryptoSignersISOTrailers_TRAILER_IMPLICIT) {
    mBuf_ = [IOSByteArray newArrayWithLength:block_->size_ - [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) getDigestSize] - lengthOfSalt - 1 - 1];
  }
  else {
    mBuf_ = [IOSByteArray newArrayWithLength:block_->size_ - [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) getDigestSize] - lengthOfSalt - 1 - 2];
  }
  [self reset];
}
...
- (jboolean)isSameAsWithByteArray:(IOSByteArray *)a
                    withByteArray:(IOSByteArray *)b {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_isSameAsWithByteArray_withByteArray_(self, a, b);
}

- (void)clearBlockWithByteArray:(IOSByteArray *)block {
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, block);
}
...
- (void)updateWithRecoveredMessageWithByteArray:(IOSByteArray *)signature {
  ...
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) doFinalWithByteArray:m2Hash withInt:0];
  IOSByteArray *dbMask = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_maskGeneratorFunction1WithByteArray_withInt_withInt_withInt_(self, block, block->size_ - hLen_ - tLength, hLen_, block->size_ - hLen_ - tLength);
...
- (void)reset {
  ...
  messageLength_ = 0;
  if (mBuf_ != nil) {
    LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, mBuf_);
  }
  if (recoveredMessage_ != nil) {
    LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, recoveredMessage_);
    recoveredMessage_ = nil;
  }
  fullMessage_ = false;
  if (preSig_ != nil) {
    preSig_ = nil;
    LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, preBlock_);
    preBlock_ = nil;
  }
}
...
- (IOSByteArray *)generateSignature {
  ...
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_LtoOSPWithLong_withByteArray_(self, messageLength_ * 8, C);
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:C withInt:0 withInt:C->size_];
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:mBuf_ withInt:0 withInt:messageLength_];
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:m2Hash withInt:0 withInt:m2Hash->size_];
  IOSByteArray *salt;
  ...
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:salt withInt:0 withInt:salt->size_];
  ...
  *IOSByteArray_GetRef(block_, off) = (jint) 0x01;
  ...
  IOSByteArray *dbMask = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_maskGeneratorFunction1WithByteArray_withInt_withInt_withInt_(self, hash_, 0, hash_->size_, ((IOSByteArray *) nil_chk(block_))->size_ - hLen_ - tLength);
  for (jint i = 0; i != ((IOSByteArray *) nil_chk(dbMask))->size_; i++) {
  ...
  *IOSByteArray_GetRef(block_, 0) &= (jint) 0x7f;
  ...
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, mBuf_);
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, block_);
  messageLength_ = 0;
  return b;
}
...
- (jboolean)verifySignatureWithByteArray:(IOSByteArray *)signature {
  ...
  preBlock_ = nil;
  IOSByteArray *C = [IOSByteArray newArrayWithLength:8];
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_LtoOSPWithLong_withByteArray_(self, ((IOSByteArray *) nil_chk(recoveredMessage_))->size_ * 8, C);
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:C withInt:0 withInt:C->size_];
  if (((IOSByteArray *) nil_chk(recoveredMessage_))->size_ != 0) {
    [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:recoveredMessage_ withInt:0 withInt:recoveredMessage_->size_];
  }
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:m2Hash withInt:0 withInt:m2Hash->size_];
  if (standardSalt_ != nil) {
    [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:standardSalt_ withInt:0 withInt:standardSalt_->size_];
  }
  else {
    [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) updateWithByteArray:block withInt:mStart + ((IOSByteArray *) nil_chk(recoveredMessage_))->size_ withInt:saltLength_];
  }
  IOSByteArray *hash_ = [IOSByteArray newArrayWithLength:[((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) getDigestSize]];
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(digest_)) doFinalWithByteArray:hash_ withInt:0];
  ...
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, block);
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, hash_);
  if (!isOkay) {
    fullMessage_ = false;
    messageLength_ = 0;
    LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, recoveredMessage_);
  ...
  if (messageLength_ != 0) {
    if (!LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_isSameAsWithByteArray_withByteArray_(self, mBuf_, recoveredMessage_)) {
      messageLength_ = 0;
      LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(self, mBuf_);
      return false;
    }
...
- (void)ItoOSPWithInt:(jint)i
        withByteArray:(IOSByteArray *)sp {
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_ItoOSPWithInt_withByteArray_(self, i, sp);
}

- (void)LtoOSPWithLong:(jlong)l
         withByteArray:(IOSByteArray *)sp {
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_LtoOSPWithLong_withByteArray_(self, l, sp);
}
...
- (IOSByteArray *)maskGeneratorFunction1WithByteArray:(IOSByteArray *)Z
                                              ...
                                              withInt:(jint)zLen
                                              withInt:(jint)length {
  return LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_maskGeneratorFunction1WithByteArray_withInt_withInt_withInt_(self, Z, zOff, zLen, length);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher:withLibOrgBouncycastleCryptoDigest:withInt:withBoolean:);
  methods[1].selector = @selector(initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher:withLibOrgBouncycastleCryptoDigest:withInt:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "TRAILER_IMPLICIT", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_IMPLICIT, 0x19, -1, -1, -1, -1 },
    { "TRAILER_RIPEMD160", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_RIPEMD160, 0x19, -1, -1, -1, -1 },
    { "TRAILER_RIPEMD128", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_RIPEMD128, 0x19, -1, -1, -1, -1 },
    { "TRAILER_SHA1", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA1, 0x19, -1, -1, -1, -1 },
    { "TRAILER_SHA256", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA256, 0x19, -1, -1, -1, -1 },
    { "TRAILER_SHA512", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA512, 0x19, -1, -1, -1, -1 },
    { "TRAILER_SHA384", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_SHA384, 0x19, -1, -1, -1, -1 },
    { "TRAILER_WHIRLPOOL", "I", .constantValue.asInt = LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_TRAILER_WHIRLPOOL, 0x19, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "LLibOrgBouncycastleCryptoAsymmetricBlockCipher;LLibOrgBouncycastleCryptoDigest;IZ", "LLibOrgBouncycastleCryptoAsymmetricBlockCipher;LLibOrgBouncycastleCryptoDigest;I", "init", "ZLLibOrgBouncycastleCryptoCipherParameters;", "isSameAs", "[B[B", "clearBlock", "[B", "updateWithRecoveredMessage", "LLibOrgBouncycastleCryptoInvalidCipherTextException;", "update", "B", "[BII", "LLibOrgBouncycastleCryptoCryptoException;", "verifySignature", "ItoOSP", "I[B", "LtoOSP", "J[B", "maskGeneratorFunction1", "[BIII" };
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner = { "ISO9796d2PSSSigner", "lib.org.bouncycastle.crypto.signers", ptrTable, methods, fields, 7, 0x1, 16, 25, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner;
}
...
LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *new_LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_withBoolean_(id<LibOrgBouncycastleCryptoAsymmetricBlockCipher> cipher, id<LibOrgBouncycastleCryptoDigest> digest, jint saltLength, jboolean implicit) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_withBoolean_, cipher, digest, saltLength, implicit)
}
...
LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *create_LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_withBoolean_(id<LibOrgBouncycastleCryptoAsymmetricBlockCipher> cipher, id<LibOrgBouncycastleCryptoDigest> digest, jint saltLength, jboolean implicit) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_withBoolean_, cipher, digest, saltLength, implicit)
}
...
void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, id<LibOrgBouncycastleCryptoAsymmetricBlockCipher> cipher, id<LibOrgBouncycastleCryptoDigest> digest, jint saltLength) {
  LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_withBoolean_(self, cipher, digest, saltLength, false);
}
...
LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *new_LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_(id<LibOrgBouncycastleCryptoAsymmetricBlockCipher> cipher, id<LibOrgBouncycastleCryptoDigest> digest, jint saltLength) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_, cipher, digest, saltLength)
}
...
LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *create_LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_(id<LibOrgBouncycastleCryptoAsymmetricBlockCipher> cipher, id<LibOrgBouncycastleCryptoDigest> digest, jint saltLength) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner, initWithLibOrgBouncycastleCryptoAsymmetricBlockCipher_withLibOrgBouncycastleCryptoDigest_withInt_, cipher, digest, saltLength)
}

jboolean LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_isSameAsWithByteArray_withByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, IOSByteArray *a, IOSByteArray *b) {
  jboolean isOkay = true;
...
void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_clearBlockWithByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, IOSByteArray *block) {
  for (jint i = 0; i != ((IOSByteArray *) nil_chk(block))->size_; i++) {
    *IOSByteArray_GetRef(block, i) = 0;
  }
}

void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_ItoOSPWithInt_withByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, jint i, IOSByteArray *sp) {
...
void LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_LtoOSPWithLong_withByteArray_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, jlong l, IOSByteArray *sp) {
...
IOSByteArray *LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_maskGeneratorFunction1WithByteArray_withInt_withInt_withInt_(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner *self, IOSByteArray *Z, jint zOff, jint zLen, jint length) {
  ...
  while (counter < (length / self->hLen_)) {
    LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner_ItoOSPWithInt_withByteArray_(self, counter, C);
    [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(self->digest_)) updateWithByteArray:Z withInt:zOff withInt:zLen];
    [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(self->digest_)) updateWithByteArray:C withInt:0 withInt:C->size_];
    [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(self->digest_)) doFinalWithByteArray:hashBuf withInt:0];
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoSignersISO9796d2PSSSigner)
