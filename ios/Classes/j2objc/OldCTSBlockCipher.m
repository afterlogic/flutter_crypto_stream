...
#include "OldCTSBlockCipher.h"
#include "OutputLengthException.h"
#include "java/lang/IllegalArgumentException.h"
#include "java/lang/System.h"

@interface LibOrgBouncycastleCryptoModesOldCTSBlockCipher () {
 @public
  jint blockSize_;
}
...
@implementation LibOrgBouncycastleCryptoModesOldCTSBlockCipher

- (instancetype)initWithLibOrgBouncycastleCryptoBlockCipher:(id<LibOrgBouncycastleCryptoBlockCipher>)cipher {
  LibOrgBouncycastleCryptoModesOldCTSBlockCipher_initWithLibOrgBouncycastleCryptoBlockCipher_(self, cipher);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoModesOldCTSBlockCipher = { "OldCTSBlockCipher", "lib.org.bouncycastle.crypto.modes", ptrTable, methods, fields, 7, 0x1, 6, 1, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoModesOldCTSBlockCipher;
}

@end

void LibOrgBouncycastleCryptoModesOldCTSBlockCipher_initWithLibOrgBouncycastleCryptoBlockCipher_(LibOrgBouncycastleCryptoModesOldCTSBlockCipher *self, id<LibOrgBouncycastleCryptoBlockCipher> cipher) {
  LibOrgBouncycastleCryptoBufferedBlockCipher_init(self);
  if (([cipher isKindOfClass:[LibOrgBouncycastleCryptoModesOFBBlockCipher class]]) || ([cipher isKindOfClass:[LibOrgBouncycastleCryptoModesCFBBlockCipher class]])) {
...
LibOrgBouncycastleCryptoModesOldCTSBlockCipher *new_LibOrgBouncycastleCryptoModesOldCTSBlockCipher_initWithLibOrgBouncycastleCryptoBlockCipher_(id<LibOrgBouncycastleCryptoBlockCipher> cipher) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoModesOldCTSBlockCipher, initWithLibOrgBouncycastleCryptoBlockCipher_, cipher)
}

LibOrgBouncycastleCryptoModesOldCTSBlockCipher *create_LibOrgBouncycastleCryptoModesOldCTSBlockCipher_initWithLibOrgBouncycastleCryptoBlockCipher_(id<LibOrgBouncycastleCryptoBlockCipher> cipher) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoModesOldCTSBlockCipher, initWithLibOrgBouncycastleCryptoBlockCipher_, cipher)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoModesOldCTSBlockCipher)
