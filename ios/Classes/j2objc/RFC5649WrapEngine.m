...
@interface LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, engine_, id<LibOrgBouncycastleCryptoBlockCipher>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, param_, LibOrgBouncycastleCryptoParamsKeyParameter *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, highOrderIV_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, preIV_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, extractedAIV_, IOSByteArray *)

__attribute__((unused)) static IOSByteArray *LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_padPlaintextWithByteArray_(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *self, IOSByteArray *plaintext);

__attribute__((unused)) static IOSByteArray *LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_rfc3394UnwrapNoIvCheckWithByteArray_withInt_withInt_(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *self, IOSByteArray *inArg, jint inOff, jint inLen);

@implementation LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine

- (instancetype)initWithLibOrgBouncycastleCryptoBlockCipher:(id<LibOrgBouncycastleCryptoBlockCipher>)engine {
  LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_initWithLibOrgBouncycastleCryptoBlockCipher_(self, engine);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)param {
  ...
  if ([param isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]]) {
    ...
    self->preIV_ = [((LibOrgBouncycastleCryptoParamsParametersWithIV *) nil_chk(((LibOrgBouncycastleCryptoParamsParametersWithIV *) param))) getIV];
...
- (IOSByteArray *)padPlaintextWithByteArray:(IOSByteArray *)plaintext {
  return LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_padPlaintextWithByteArray_(self, plaintext);
}
...
- (IOSByteArray *)wrapWithByteArray:(IOSByteArray *)inArg
  ...
  IOSByteArray *mli = LibOrgBouncycastleUtilPack_intToBigEndianWithInt_(inLen);
  ...
  IOSByteArray *paddedPlaintext = LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_padPlaintextWithByteArray_(self, relevantPlaintext);
  if (((IOSByteArray *) nil_chk(paddedPlaintext))->size_ == 8) {
    ...
    [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(engine_)) init__WithBoolean:true withLibOrgBouncycastleCryptoCipherParameters:param_];
    for (jint i = 0; i < paddedPlainTextWithIV->size_; i += [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(engine_)) getBlockSize]) {
      [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(engine_)) processBlockWithByteArray:paddedPlainTextWithIV withInt:i withByteArray:paddedPlainTextWithIV withInt:i];
    }
    return paddedPlainTextWithIV;
  }
  else {
    id<LibOrgBouncycastleCryptoWrapper> wrapper = new_LibOrgBouncycastleCryptoEnginesRFC3394WrapEngine_initWithLibOrgBouncycastleCryptoBlockCipher_(engine_);
    LibOrgBouncycastleCryptoParamsParametersWithIV *paramsWithIV = new_LibOrgBouncycastleCryptoParamsParametersWithIV_initWithLibOrgBouncycastleCryptoCipherParameters_withByteArray_(param_, iv);
    [wrapper init__WithBoolean:true withLibOrgBouncycastleCryptoCipherParameters:paramsWithIV];
...
- (IOSByteArray *)unwrapWithByteArray:(IOSByteArray *)inArg
  ...
  if (n == 1) {
    @throw new_LibOrgBouncycastleCryptoInvalidCipherTextException_initWithNSString_(@"unwrap data must be at least 16 bytes");
  }
  ...
  if (n == 2) {
    [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(engine_)) init__WithBoolean:false withLibOrgBouncycastleCryptoCipherParameters:param_];
    for (jint i = 0; i < relevantCiphertext->size_; i += [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(engine_)) getBlockSize]) {
      [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(engine_)) processBlockWithByteArray:relevantCiphertext withInt:i withByteArray:decrypted withInt:i];
    }
    ...
    decrypted = LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_rfc3394UnwrapNoIvCheckWithByteArray_withInt_withInt_(self, inArg, inOff, inLen);
  ...
  jint mli = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(mliBytes, 0);
  jboolean isValid = true;
  if (!LibOrgBouncycastleUtilArrays_constantTimeAreEqualWithByteArray_withByteArray_(extractedHighOrderAIV, preIV_)) {
    isValid = false;
  }
  ...
  if (!LibOrgBouncycastleUtilArrays_constantTimeAreEqualWithByteArray_withByteArray_(pad, zeros)) {
    isValid = false;
  }
  if (!isValid) {
...
- (IOSByteArray *)rfc3394UnwrapNoIvCheckWithByteArray:(IOSByteArray *)inArg
                                              withInt:(jint)inOff
                                              withInt:(jint)inLen {
  return LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_rfc3394UnwrapNoIvCheckWithByteArray_withInt_withInt_(self, inArg, inOff, inLen);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LLibOrgBouncycastleCryptoBlockCipher;", "init", "ZLLibOrgBouncycastleCryptoCipherParameters;", "padPlaintext", "[B", "wrap", "[BII", "unwrap", "LLibOrgBouncycastleCryptoInvalidCipherTextException;", "rfc3394UnwrapNoIvCheck" };
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine = { "RFC5649WrapEngine", "lib.org.bouncycastle.crypto.engines", ptrTable, methods, fields, 7, 0x1, 7, 6, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine;
}

@end

void LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_initWithLibOrgBouncycastleCryptoBlockCipher_(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *self, id<LibOrgBouncycastleCryptoBlockCipher> engine) {
  NSObject_init(self);
...
LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *new_LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_initWithLibOrgBouncycastleCryptoBlockCipher_(id<LibOrgBouncycastleCryptoBlockCipher> engine) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, initWithLibOrgBouncycastleCryptoBlockCipher_, engine)
}

LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *create_LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_initWithLibOrgBouncycastleCryptoBlockCipher_(id<LibOrgBouncycastleCryptoBlockCipher> engine) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine, initWithLibOrgBouncycastleCryptoBlockCipher_, engine)
}

IOSByteArray *LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_padPlaintextWithByteArray_(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *self, IOSByteArray *plaintext) {
...
IOSByteArray *LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine_rfc3394UnwrapNoIvCheckWithByteArray_withInt_withInt_(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine *self, IOSByteArray *inArg, jint inOff, jint inLen) {
  IOSByteArray *iv = [IOSByteArray newArrayWithLength:8];
  ...
  [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(self->engine_)) init__WithBoolean:false withLibOrgBouncycastleCryptoCipherParameters:self->param_];
  jint n = inLen / 8;
  n = n - 1;
  for (jint j = 5; j >= 0; j--) {
    for (jint i = n; i >= 1; i--) {
      ...
      [((id<LibOrgBouncycastleCryptoBlockCipher>) nil_chk(self->engine_)) processBlockWithByteArray:buf withInt:0 withByteArray:buf withInt:0];
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesRFC5649WrapEngine)
