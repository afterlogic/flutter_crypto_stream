...
#include "X509StoreCertCollection.h"
#include "X509StoreParameters.h"
#include "X509StoreSpi.h"
#include "java/lang/IllegalArgumentException.h"
#include "java/util/Collection.h"

@interface LibOrgBouncycastleJceProviderX509StoreCertCollection () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJceProviderX509StoreCertCollection, _store_, LibOrgBouncycastleUtilCollectionStore *)

@implementation LibOrgBouncycastleJceProviderX509StoreCertCollection

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleJceProviderX509StoreCertCollection_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleJceProviderX509StoreCertCollection = { "X509StoreCertCollection", "lib.org.bouncycastle.jce.provider", ptrTable, methods, fields, 7, 0x1, 3, 1, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJceProviderX509StoreCertCollection;
}

@end

void LibOrgBouncycastleJceProviderX509StoreCertCollection_init(LibOrgBouncycastleJceProviderX509StoreCertCollection *self) {
  LibOrgBouncycastleX509X509StoreSpi_init(self);
}

LibOrgBouncycastleJceProviderX509StoreCertCollection *new_LibOrgBouncycastleJceProviderX509StoreCertCollection_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJceProviderX509StoreCertCollection, init)
}

LibOrgBouncycastleJceProviderX509StoreCertCollection *create_LibOrgBouncycastleJceProviderX509StoreCertCollection_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJceProviderX509StoreCertCollection, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJceProviderX509StoreCertCollection)
