...
#include "ECGOST2012SignatureSpi512.h"
...
@interface LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512 () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512, digest_, id<LibOrgBouncycastleCryptoDigest>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512, signer_, id<LibOrgBouncycastleCryptoDSAExt>)

@implementation LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_init(self);
  return self;
}
...
- (void)engineInitVerifyWithJavaSecurityPublicKey:(id<JavaSecurityPublicKey>)publicKey {
  ...
  if ([LibOrgBouncycastleJceInterfacesECPublicKey_class_() isInstance:publicKey]) {
    param = (LibOrgBouncycastleCryptoParamsECKeyParameters *) cast_chk(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_generatePublicKeyParameterWithJavaSecurityPublicKey_(publicKey), [LibOrgBouncycastleCryptoParamsECKeyParameters class]);
  }
  else {
    @try {
    ...
    @catch (JavaLangException *e) {
      @throw new_JavaSecurityInvalidKeyException_initWithNSString_(@"cannot recognise key type in ECGOST-2012-512 signer");
    }
  }
  if ([((JavaMathBigInteger *) nil_chk([((LibOrgBouncycastleCryptoParamsECDomainParameters *) nil_chk([((LibOrgBouncycastleCryptoParamsECKeyParameters *) nil_chk(param)) getParameters])) getN])) bitLength] < 505) {
    @throw new_JavaSecurityInvalidKeyException_initWithNSString_(@"key too weak for ECGOST-2012-512");
  }
...
+ (LibOrgBouncycastleCryptoParamsAsymmetricKeyParameter *)generatePublicKeyParameterWithJavaSecurityPublicKey:(id<JavaSecurityPublicKey>)key {
  return LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_generatePublicKeyParameterWithJavaSecurityPublicKey_(key);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512 = { "ECGOST2012SignatureSpi512", "lib.org.bouncycastle.jcajce.provider.asymmetric.ecgost12", ptrTable, methods, fields, 7, 0x1, 11, 4, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512;
}

@end

void LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_init(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512 *self) {
  JavaSecuritySignatureSpi_init(self);
  self->size_ = 128;
  self->halfSize_ = 64;
  self->digest_ = new_LibOrgBouncycastleCryptoDigestsGOST3411_2012_512Digest_init();
  self->signer_ = new_LibOrgBouncycastleCryptoSignersECGOST3410_2012Signer_init();
}

LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512 *new_LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512, init)
}

LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512 *create_LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512, init)
}

LibOrgBouncycastleCryptoParamsAsymmetricKeyParameter *LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_generatePublicKeyParameterWithJavaSecurityPublicKey_(id<JavaSecurityPublicKey> key) {
  LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512_initialize();
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJcajceProviderAsymmetricEcgost12ECGOST2012SignatureSpi512)
