...
@interface LibOrgBouncycastleJceProviderX509CRLEntryObject () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJceProviderX509CRLEntryObject, c_, LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJceProviderX509CRLEntryObject, certificateIssuer_, LibOrgBouncycastleAsn1X500X500Name *)

__attribute__((unused)) static LibOrgBouncycastleAsn1X500X500Name *LibOrgBouncycastleJceProviderX509CRLEntryObject_loadCertificateIssuerWithBoolean_withLibOrgBouncycastleAsn1X500X500Name_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, jboolean isIndirect, LibOrgBouncycastleAsn1X500X500Name *previousCertificateIssuer);

__attribute__((unused)) static id<JavaUtilSet> LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionOIDsWithBoolean_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, jboolean critical);

__attribute__((unused)) static LibOrgBouncycastleAsn1X509Extension *LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, LibOrgBouncycastleAsn1ASN1ObjectIdentifier *oid);

@implementation LibOrgBouncycastleJceProviderX509CRLEntryObject

- (instancetype)initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry:(LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *)c {
  LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_(self, c);
  return self;
}
...
- (instancetype)initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry:(LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *)c
                                ...
                                withLibOrgBouncycastleAsn1X500X500Name:(LibOrgBouncycastleAsn1X500X500Name *)previousCertificateIssuer {
  LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_(self, c, isIndirect, previousCertificateIssuer);
  return self;
}
...
- (LibOrgBouncycastleAsn1X500X500Name *)loadCertificateIssuerWithBoolean:(jboolean)isIndirect
                                  withLibOrgBouncycastleAsn1X500X500Name:(LibOrgBouncycastleAsn1X500X500Name *)previousCertificateIssuer {
  return LibOrgBouncycastleJceProviderX509CRLEntryObject_loadCertificateIssuerWithBoolean_withLibOrgBouncycastleAsn1X500X500Name_(self, isIndirect, previousCertificateIssuer);
}
...
- (id<JavaUtilSet>)getExtensionOIDsWithBoolean:(jboolean)critical {
  return LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionOIDsWithBoolean_(self, critical);
}

- (id<JavaUtilSet>)getCriticalExtensionOIDs {
  return LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionOIDsWithBoolean_(self, true);
}

- (id<JavaUtilSet>)getNonCriticalExtensionOIDs {
  return LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionOIDsWithBoolean_(self, false);
}

- (LibOrgBouncycastleAsn1X509Extension *)getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier:(LibOrgBouncycastleAsn1ASN1ObjectIdentifier *)oid {
  return LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier_(self, oid);
}

- (IOSByteArray *)getExtensionValueWithNSString:(NSString *)oid {
  LibOrgBouncycastleAsn1X509Extension *ext = LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier_(self, new_LibOrgBouncycastleAsn1ASN1ObjectIdentifier_initWithNSString_(oid));
  if (ext != nil) {
    @try {
...
- (jboolean)isEqual:(id)o {
  ...
  if ([o isKindOfClass:[LibOrgBouncycastleJceProviderX509CRLEntryObject class]]) {
    LibOrgBouncycastleJceProviderX509CRLEntryObject *other = (LibOrgBouncycastleJceProviderX509CRLEntryObject *) o;
    return [((LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *) nil_chk(self->c_)) isEqual:((LibOrgBouncycastleJceProviderX509CRLEntryObject *) nil_chk(other))->c_];
  }
    ...
    if ([((id<JavaUtilEnumeration>) nil_chk(e)) hasMoreElements]) {
      ...
      while ([e hasMoreElements]) {
        ...
        if ([((LibOrgBouncycastleAsn1X509Extension *) nil_chk(ext)) getExtnValue] != nil) {
          ...
          @try {
            if ([((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(oid)) isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509X509Extension, reasonCode)]) {
            ...
            else if ([oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509X509Extension, certificateIssuer)]) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleJceProviderX509CRLEntryObject = { "X509CRLEntryObject", "lib.org.bouncycastle.jce.provider", ptrTable, methods, fields, 7, 0x1, 17, 4, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJceProviderX509CRLEntryObject;
}

@end

void LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *c) {
  JavaSecurityCertX509CRLEntry_init(self);
  self->c_ = c;
  self->certificateIssuer_ = nil;
}

LibOrgBouncycastleJceProviderX509CRLEntryObject *new_LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_(LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *c) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJceProviderX509CRLEntryObject, initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_, c)
}

LibOrgBouncycastleJceProviderX509CRLEntryObject *create_LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_(LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *c) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJceProviderX509CRLEntryObject, initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_, c)
}
...
void LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *c, jboolean isIndirect, LibOrgBouncycastleAsn1X500X500Name *previousCertificateIssuer) {
  JavaSecurityCertX509CRLEntry_init(self);
  self->c_ = c;
  self->certificateIssuer_ = LibOrgBouncycastleJceProviderX509CRLEntryObject_loadCertificateIssuerWithBoolean_withLibOrgBouncycastleAsn1X500X500Name_(self, isIndirect, previousCertificateIssuer);
}

LibOrgBouncycastleJceProviderX509CRLEntryObject *new_LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_(LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *c, jboolean isIndirect, LibOrgBouncycastleAsn1X500X500Name *previousCertificateIssuer) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJceProviderX509CRLEntryObject, initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_, c, isIndirect, previousCertificateIssuer)
}

LibOrgBouncycastleJceProviderX509CRLEntryObject *create_LibOrgBouncycastleJceProviderX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_(LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *c, jboolean isIndirect, LibOrgBouncycastleAsn1X500X500Name *previousCertificateIssuer) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJceProviderX509CRLEntryObject, initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_, c, isIndirect, previousCertificateIssuer)
}

LibOrgBouncycastleAsn1X500X500Name *LibOrgBouncycastleJceProviderX509CRLEntryObject_loadCertificateIssuerWithBoolean_withLibOrgBouncycastleAsn1X500X500Name_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, jboolean isIndirect, LibOrgBouncycastleAsn1X500X500Name *previousCertificateIssuer) {
  if (!isIndirect) {
    return nil;
  }
  LibOrgBouncycastleAsn1X509Extension *ext = LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier_(self, JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, certificateIssuer));
  if (ext == nil) {
...
id<JavaUtilSet> LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionOIDsWithBoolean_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, jboolean critical) {
...
LibOrgBouncycastleAsn1X509Extension *LibOrgBouncycastleJceProviderX509CRLEntryObject_getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier_(LibOrgBouncycastleJceProviderX509CRLEntryObject *self, LibOrgBouncycastleAsn1ASN1ObjectIdentifier *oid) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJceProviderX509CRLEntryObject)
