...
@implementation LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi_init(self);
  return self;
}
...
- (id<JavaSecurityPrivateKey>)engineGeneratePrivateWithJavaSecuritySpecKeySpec:(id<JavaSecuritySpecKeySpec>)keySpec {
  if ([keySpec isKindOfClass:[LibOrgBouncycastleJceSpecECPrivateKeySpec class]]) {
    return new_LibOrgBouncycastleJcajceProviderAsymmetricDstuBCDSTU4145PrivateKey_initWithLibOrgBouncycastleJceSpecECPrivateKeySpec_((LibOrgBouncycastleJceSpecECPrivateKeySpec *) keySpec);
  }
  else if ([keySpec isKindOfClass:[JavaSecuritySpecECPrivateKeySpec class]]) {
    return new_LibOrgBouncycastleJcajceProviderAsymmetricDstuBCDSTU4145PrivateKey_initWithJavaSecuritySpecECPrivateKeySpec_((JavaSecuritySpecECPrivateKeySpec *) keySpec);
  }
...
- (id<JavaSecurityPublicKey>)engineGeneratePublicWithJavaSecuritySpecKeySpec:(id<JavaSecuritySpecKeySpec>)keySpec {
  if ([keySpec isKindOfClass:[LibOrgBouncycastleJceSpecECPublicKeySpec class]]) {
    return new_LibOrgBouncycastleJcajceProviderAsymmetricDstuBCDSTU4145PublicKey_initWithLibOrgBouncycastleJceSpecECPublicKeySpec_withLibOrgBouncycastleJcajceProviderConfigProviderConfiguration_((LibOrgBouncycastleJceSpecECPublicKeySpec *) keySpec, JreLoadStatic(LibOrgBouncycastleJceProviderBouncyCastleProvider, CONFIGURATION));
  }
  else if ([keySpec isKindOfClass:[JavaSecuritySpecECPublicKeySpec class]]) {
    return new_LibOrgBouncycastleJcajceProviderAsymmetricDstuBCDSTU4145PublicKey_initWithJavaSecuritySpecECPublicKeySpec_((JavaSecuritySpecECPublicKeySpec *) keySpec);
  }
...
- (id<JavaSecurityPrivateKey>)generatePrivateWithLibOrgBouncycastleAsn1PkcsPrivateKeyInfo:(LibOrgBouncycastleAsn1PkcsPrivateKeyInfo *)keyInfo {
  ...
  if ([((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(algOid)) isEqual:JreLoadStatic(LibOrgBouncycastleAsn1UaUAObjectIdentifiers, dstu4145le)] || [algOid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1UaUAObjectIdentifiers, dstu4145be)]) {
    return new_LibOrgBouncycastleJcajceProviderAsymmetricDstuBCDSTU4145PrivateKey_initWithLibOrgBouncycastleAsn1PkcsPrivateKeyInfo_(keyInfo);
  }
  else {
...
- (id<JavaSecurityPublicKey>)generatePublicWithLibOrgBouncycastleAsn1X509SubjectPublicKeyInfo:(LibOrgBouncycastleAsn1X509SubjectPublicKeyInfo *)keyInfo {
  ...
  if ([((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(algOid)) isEqual:JreLoadStatic(LibOrgBouncycastleAsn1UaUAObjectIdentifiers, dstu4145le)] || [algOid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1UaUAObjectIdentifiers, dstu4145be)]) {
    return new_LibOrgBouncycastleJcajceProviderAsymmetricDstuBCDSTU4145PublicKey_initWithLibOrgBouncycastleAsn1X509SubjectPublicKeyInfo_(keyInfo);
  }
  else {
    @throw new_JavaIoIOException_initWithNSString_(JreStrcat("$@$", @"algorithm identifier ", algOid, @" in key not recognised"));
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi = { "JcajceDstuKeyFactorySpi", "lib.org.bouncycastle.jcajce.provider.asymmetric.dstu", ptrTable, methods, NULL, 7, 0x1, 7, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi;
}

@end

void LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi_init(LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi *self) {
  LibOrgBouncycastleJcajceProviderAsymmetricUtilBaseKeyFactorySpi_init(self);
}

LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi *new_LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi, init)
}

LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi *create_LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJcajceProviderAsymmetricDstuJcajceDstuKeyFactorySpi)
