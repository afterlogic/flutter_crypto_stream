...
@implementation LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi_init(self);
  return self;
}
...
- (id<JavaSecuritySpecKeySpec>)engineGetKeySpecWithJavaSecurityKey:(id<JavaSecurityKey>)key
  ...
  if ([key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSPrivateKey class]]) {
  ...
  else if ([key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSPublicKey class]]) {
...
- (id<JavaSecurityKey>)engineTranslateKeyWithJavaSecurityKey:(id<JavaSecurityKey>)key {
  if ([key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSPrivateKey class]] || [key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSPublicKey class]]) {
    return key;
  }
...
- (id<JavaSecurityPrivateKey>)generatePrivateWithLibOrgBouncycastleAsn1PkcsPrivateKeyInfo:(LibOrgBouncycastleAsn1PkcsPrivateKeyInfo *)keyInfo {
  return new_LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSPrivateKey_initWithLibOrgBouncycastleAsn1PkcsPrivateKeyInfo_(keyInfo);
}
...
- (id<JavaSecurityPublicKey>)generatePublicWithLibOrgBouncycastleAsn1X509SubjectPublicKeyInfo:(LibOrgBouncycastleAsn1X509SubjectPublicKeyInfo *)keyInfo {
  return new_LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSPublicKey_initWithLibOrgBouncycastleAsn1X509SubjectPublicKeyInfo_(keyInfo);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi = { "XMSSKeyFactorySpi", "lib.org.bouncycastle.pqc.jcajce.provider.xmss", ptrTable, methods, NULL, 7, 0x1, 7, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi;
}

@end

void LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi_init(LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi *self) {
  JavaSecurityKeyFactorySpi_init(self);
}

LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi *new_LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi, init)
}

LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi *create_LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastlePqcJcajceProviderXmssXMSSKeyFactorySpi)
