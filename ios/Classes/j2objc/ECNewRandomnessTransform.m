...
#include "ECNewRandomnessTransform.h"
#include "ECPair.h"
#include "ECPoint.h"
...
@interface LibOrgBouncycastleCryptoEcECNewRandomnessTransform () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEcECNewRandomnessTransform, key_, LibOrgBouncycastleCryptoParamsECPublicKeyParameters *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEcECNewRandomnessTransform, random_, JavaSecuritySecureRandom *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEcECNewRandomnessTransform, lastK_, JavaMathBigInteger *)

@implementation LibOrgBouncycastleCryptoEcECNewRandomnessTransform

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEcECNewRandomnessTransform_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoEcECNewRandomnessTransform = { "ECNewRandomnessTransform", "lib.org.bouncycastle.crypto.ec", ptrTable, methods, fields, 7, 0x1, 5, 3, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoEcECNewRandomnessTransform;
}

@end

void LibOrgBouncycastleCryptoEcECNewRandomnessTransform_init(LibOrgBouncycastleCryptoEcECNewRandomnessTransform *self) {
  NSObject_init(self);
}

LibOrgBouncycastleCryptoEcECNewRandomnessTransform *new_LibOrgBouncycastleCryptoEcECNewRandomnessTransform_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEcECNewRandomnessTransform, init)
}

LibOrgBouncycastleCryptoEcECNewRandomnessTransform *create_LibOrgBouncycastleCryptoEcECNewRandomnessTransform_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEcECNewRandomnessTransform, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEcECNewRandomnessTransform)
