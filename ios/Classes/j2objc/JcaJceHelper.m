...
@interface LibOrgBouncycastleJcajceUtilJcaJceHelper : NSObject

@end

@implementation LibOrgBouncycastleJcajceUtilJcaJceHelper
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleJcajceUtilJcaJceHelper = { "JcaJceHelper", "lib.org.bouncycastle.jcajce.util", ptrTable, methods, NULL, 7, 0x609, 13, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJcajceUtilJcaJceHelper;
}

@end

J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJcajceUtilJcaJceHelper)
