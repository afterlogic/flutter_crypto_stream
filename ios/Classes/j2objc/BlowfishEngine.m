...
@interface LibOrgBouncycastleCryptoEnginesBlowfishEngine () {
 @public
  IOSIntArray *S0_;
  IOSIntArray *S1_;
  IOSIntArray *S2_;
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesBlowfishEngine, S0_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesBlowfishEngine, S1_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesBlowfishEngine, S2_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesBlowfishEngine, S3_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesBlowfishEngine, P_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesBlowfishEngine, workingKey_, IOSByteArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_KP(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_KP;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesBlowfishEngine, KP, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_KS0(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS0;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesBlowfishEngine, KS0, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_KS1(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS1;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesBlowfishEngine, KS1, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_KS2(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS2;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesBlowfishEngine, KS2, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_KS3(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS3;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesBlowfishEngine, KS3, IOSIntArray *)

inline jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_ROUNDS(void);
#define LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS 16
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesBlowfishEngine, ROUNDS, jint)

inline jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_BLOCK_SIZE(void);
#define LibOrgBouncycastleCryptoEnginesBlowfishEngine_BLOCK_SIZE 8
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesBlowfishEngine, BLOCK_SIZE, jint)

inline jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_SBOX_SK(void);
#define LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK 256
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesBlowfishEngine, SBOX_SK, jint)

inline jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_get_P_SZ(void);
#define LibOrgBouncycastleCryptoEnginesBlowfishEngine_P_SZ 18
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesBlowfishEngine, P_SZ, jint)

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, jint x);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, jint xl, jint xr, IOSIntArray *table);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesBlowfishEngine_setKeyWithByteArray_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *key);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesBlowfishEngine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *src, jint srcIndex, IOSByteArray *dst, jint dstIndex);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesBlowfishEngine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *src, jint srcIndex, IOSByteArray *dst, jint dstIndex);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *b, jint i);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesBlowfishEngine_Bits32ToBytesWithInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, jint inArg, IOSByteArray *b, jint offset);

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesBlowfishEngine)

@implementation LibOrgBouncycastleCryptoEnginesBlowfishEngine

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_init(self);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  if ([params isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]]) {
    ...
    LibOrgBouncycastleCryptoEnginesBlowfishEngine_setKeyWithByteArray_(self, self->workingKey_);
    return;
  }
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"invalid parameter passed to Blowfish init - ", [[((id<LibOrgBouncycastleCryptoCipherParameters>) nil_chk(params)) java_getClass] getName]));
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if ((inOff + LibOrgBouncycastleCryptoEnginesBlowfishEngine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(inArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if ((outOff + LibOrgBouncycastleCryptoEnginesBlowfishEngine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(outArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoOutputLengthException_initWithNSString_(@"output buffer too short");
  }
  if (encrypting_) {
    LibOrgBouncycastleCryptoEnginesBlowfishEngine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(self, inArg, inOff, outArg, outOff);
  }
  else {
    LibOrgBouncycastleCryptoEnginesBlowfishEngine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(self, inArg, inOff, outArg, outOff);
  }
  return LibOrgBouncycastleCryptoEnginesBlowfishEngine_BLOCK_SIZE;
}
...
- (jint)FWithInt:(jint)x {
  return LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, x);
}

- (void)processTableWithInt:(jint)xl
                    withInt:(jint)xr
               withIntArray:(IOSIntArray *)table {
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(self, xl, xr, table);
}

- (void)setKeyWithByteArray:(IOSByteArray *)key {
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_setKeyWithByteArray_(self, key);
}
...
- (void)encryptBlockWithByteArray:(IOSByteArray *)src
                    ...
                    withByteArray:(IOSByteArray *)dst
                          withInt:(jint)dstIndex {
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(self, src, srcIndex, dst, dstIndex);
}
...
- (void)decryptBlockWithByteArray:(IOSByteArray *)src
                    ...
                    withByteArray:(IOSByteArray *)dst
                          withInt:(jint)dstIndex {
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(self, src, srcIndex, dst, dstIndex);
}

- (jint)BytesTo32bitsWithByteArray:(IOSByteArray *)b
                           withInt:(jint)i {
  return LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(self, b, i);
}

- (void)Bits32ToBytesWithInt:(jint)inArg
               withByteArray:(IOSByteArray *)b
                     withInt:(jint)offset {
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_Bits32ToBytesWithInt_withByteArray_withInt_(self, inArg, b, offset);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "ROUNDS", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS, 0x1a, -1, -1, -1, -1 },
    { "BLOCK_SIZE", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesBlowfishEngine_BLOCK_SIZE, 0x1a, -1, -1, -1, -1 },
    { "SBOX_SK", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK, 0x1a, -1, -1, -1, -1 },
    { "P_SZ", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesBlowfishEngine_P_SZ, 0x1a, -1, -1, -1, -1 },
...
void LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, jint xl, jint xr, IOSIntArray *table) {
  jint size = ((IOSIntArray *) nil_chk(table))->size_;
  for (jint s = 0; s < size; s += 2) {
    xl ^= IOSIntArray_Get(nil_chk(self->P_), 0);
    for (jint i = 1; i < LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS; i += 2) {
      xr ^= LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, xl) ^ IOSIntArray_Get(self->P_, i);
      xl ^= LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, xr) ^ IOSIntArray_Get(self->P_, i + 1);
    }
    xr ^= IOSIntArray_Get(self->P_, LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS + 1);
...
void LibOrgBouncycastleCryptoEnginesBlowfishEngine_setKeyWithByteArray_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *key) {
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS0, 0, self->S0_, 0, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS1, 0, self->S1_, 0, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS2, 0, self->S2_, 0, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine_KS3, 0, self->S3_, 0, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine_KP, 0, self->P_, 0, LibOrgBouncycastleCryptoEnginesBlowfishEngine_P_SZ);
  jint keyLength = ((IOSByteArray *) nil_chk(key))->size_;
  jint keyIndex = 0;
  for (jint i = 0; i < LibOrgBouncycastleCryptoEnginesBlowfishEngine_P_SZ; i++) {
  ...
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(self, 0, 0, self->P_);
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(self, IOSIntArray_Get(nil_chk(self->P_), LibOrgBouncycastleCryptoEnginesBlowfishEngine_P_SZ - 2), IOSIntArray_Get(self->P_, LibOrgBouncycastleCryptoEnginesBlowfishEngine_P_SZ - 1), self->S0_);
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(self, IOSIntArray_Get(nil_chk(self->S0_), LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK - 2), IOSIntArray_Get(self->S0_, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK - 1), self->S1_);
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(self, IOSIntArray_Get(nil_chk(self->S1_), LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK - 2), IOSIntArray_Get(self->S1_, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK - 1), self->S2_);
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_processTableWithInt_withInt_withIntArray_(self, IOSIntArray_Get(nil_chk(self->S2_), LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK - 2), IOSIntArray_Get(self->S2_, LibOrgBouncycastleCryptoEnginesBlowfishEngine_SBOX_SK - 1), self->S3_);
}

void LibOrgBouncycastleCryptoEnginesBlowfishEngine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *src, jint srcIndex, IOSByteArray *dst, jint dstIndex) {
  jint xl = LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(self, src, srcIndex);
  jint xr = LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(self, src, srcIndex + 4);
  xl ^= IOSIntArray_Get(nil_chk(self->P_), 0);
  for (jint i = 1; i < LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS; i += 2) {
    xr ^= LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, xl) ^ IOSIntArray_Get(self->P_, i);
    xl ^= LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, xr) ^ IOSIntArray_Get(self->P_, i + 1);
  ...
  xr ^= IOSIntArray_Get(self->P_, LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS + 1);
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_Bits32ToBytesWithInt_withByteArray_withInt_(self, xr, dst, dstIndex);
  LibOrgBouncycastleCryptoEnginesBlowfishEngine_Bits32ToBytesWithInt_withByteArray_withInt_(self, xl, dst, dstIndex + 4);
}

void LibOrgBouncycastleCryptoEnginesBlowfishEngine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *src, jint srcIndex, IOSByteArray *dst, jint dstIndex) {
  jint xl = LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(self, src, srcIndex);
  jint xr = LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(self, src, srcIndex + 4);
  xl ^= IOSIntArray_Get(nil_chk(self->P_), LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS + 1);
  for (jint i = LibOrgBouncycastleCryptoEnginesBlowfishEngine_ROUNDS; i > 0; i -= 2) {
    xr ^= LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, xl) ^ IOSIntArray_Get(self->P_, i);
    xl ^= LibOrgBouncycastleCryptoEnginesBlowfishEngine_FWithInt_(self, xr) ^ IOSIntArray_Get(self->P_, i - 1);
  }
...
jint LibOrgBouncycastleCryptoEnginesBlowfishEngine_BytesTo32bitsWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, IOSByteArray *b, jint i) {
...
void LibOrgBouncycastleCryptoEnginesBlowfishEngine_Bits32ToBytesWithInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesBlowfishEngine *self, jint inArg, IOSByteArray *b, jint offset) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesBlowfishEngine)
