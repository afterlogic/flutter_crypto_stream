...
@interface LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, bcHelper_, id<LibOrgBouncycastleJcajceUtilJcaJceHelper>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, c_, LibOrgBouncycastleAsn1X509X509Certificate *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, basicConstraints_, LibOrgBouncycastleAsn1X509BasicConstraints *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, keyUsage_, IOSBooleanArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, attrCarrier_, id<LibOrgBouncycastleJceInterfacesPKCS12BagAttributeCarrier>)

__attribute__((unused)) static IOSByteArray *LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *self, NSString *oid);

__attribute__((unused)) static void LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_checkSignatureWithJavaSecurityPublicKey_withJavaSecuritySignature_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *self, id<JavaSecurityPublicKey> key, JavaSecuritySignature *signature);

__attribute__((unused)) static jboolean LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_isAlgIdEqualWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier_withLibOrgBouncycastleAsn1X509AlgorithmIdentifier_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *self, LibOrgBouncycastleAsn1X509AlgorithmIdentifier *id1, LibOrgBouncycastleAsn1X509AlgorithmIdentifier *id2);

__attribute__((unused)) static id<JavaUtilCollection> LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getAlternativeNamesWithByteArray_(IOSByteArray *extVal);

@implementation LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject

- (instancetype)initWithLibOrgBouncycastleJcajceUtilJcaJceHelper:(id<LibOrgBouncycastleJcajceUtilJcaJceHelper>)bcHelper
                   withLibOrgBouncycastleAsn1X509X509Certificate:(LibOrgBouncycastleAsn1X509X509Certificate *)c {
  LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509X509Certificate_(self, bcHelper, c);
  return self;
}
...
- (NSString *)getSigAlgName {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509SignatureUtil_getSignatureNameWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier_([((LibOrgBouncycastleAsn1X509X509Certificate *) nil_chk(c_)) getSignatureAlgorithm]);
}
...
- (id<JavaUtilList>)getExtendedKeyUsage {
  IOSByteArray *bytes = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(self, @"2.5.29.37");
  if (bytes != nil) {
    @try {
...
- (id<JavaUtilCollection>)getSubjectAlternativeNames {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getAlternativeNamesWithByteArray_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(self, [((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, subjectAlternativeName))) getId]));
}
...
- (IOSByteArray *)getExtensionBytesWithNSString:(NSString *)oid {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(self, oid);
}
...
- (jboolean)hasUnsupportedCriticalExtension {
  if ([self getVersion] == 3) {
    ...
    if (extensions != nil) {
      ...
      while ([((id<JavaUtilEnumeration>) nil_chk(e)) hasMoreElements]) {
        LibOrgBouncycastleAsn1ASN1ObjectIdentifier *oid = (LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) cast_chk([e nextElement], [LibOrgBouncycastleAsn1ASN1ObjectIdentifier class]);
        if ([((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(oid)) isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, keyUsage)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, certificatePolicies)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, policyMappings)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, inhibitAnyPolicy)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, cRLDistributionPoints)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, issuingDistributionPoint)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, deltaCRLIndicator)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, policyConstraints)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, basicConstraints)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, subjectAlternativeName)] || [oid isEqual:JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, nameConstraints)]) {
          continue;
        }
        LibOrgBouncycastleAsn1X509Extension *ext = [extensions getExtensionWithLibOrgBouncycastleAsn1ASN1ObjectIdentifier:oid];
        if ([((LibOrgBouncycastleAsn1X509Extension *) nil_chk(ext)) isCritical]) {
...
- (jboolean)isEqual:(id)o {
  ...
  if ([o isKindOfClass:[LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject class]]) {
    LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *other = (LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *) o;
    if (self->hashValueSet_ && ((LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *) nil_chk(other))->hashValueSet_) {
      if (self->hashValue_ != ((LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *) nil_chk(other))->hashValue_) {
        return false;
      }
    }
    return [((LibOrgBouncycastleAsn1X509X509Certificate *) nil_chk(self->c_)) isEqual:((LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *) nil_chk(other))->c_];
  }
...
- (void)verifyWithJavaSecurityPublicKey:(id<JavaSecurityPublicKey>)key {
  ...
  NSString *sigName = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509SignatureUtil_getSignatureNameWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier_([((LibOrgBouncycastleAsn1X509X509Certificate *) nil_chk(c_)) getSignatureAlgorithm]);
  @try {
    signature = [((id<LibOrgBouncycastleJcajceUtilJcaJceHelper>) nil_chk(bcHelper_)) createSignatureWithNSString:sigName];
  }
  @catch (JavaLangException *e) {
    signature = JavaSecuritySignature_getInstanceWithNSString_(sigName);
  }
  LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_checkSignatureWithJavaSecurityPublicKey_withJavaSecuritySignature_(self, key, signature);
}
...
- (jboolean)isAlgIdEqualWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier:(LibOrgBouncycastleAsn1X509AlgorithmIdentifier *)id1
                        withLibOrgBouncycastleAsn1X509AlgorithmIdentifier:(LibOrgBouncycastleAsn1X509AlgorithmIdentifier *)id2 {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_isAlgIdEqualWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier_withLibOrgBouncycastleAsn1X509AlgorithmIdentifier_(self, id1, id2);
}

+ (id<JavaUtilCollection>)getAlternativeNamesWithByteArray:(IOSByteArray *)extVal {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getAlternativeNamesWithByteArray_(extVal);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[0].selector = @selector(initWithLibOrgBouncycastleJcajceUtilJcaJceHelper:withLibOrgBouncycastleAsn1X509X509Certificate:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "bcHelper_", "LLibOrgBouncycastleJcajceUtilJcaJceHelper;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
...
void LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509X509Certificate_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *self, id<LibOrgBouncycastleJcajceUtilJcaJceHelper> bcHelper, LibOrgBouncycastleAsn1X509X509Certificate *c) {
  ...
  self->c_ = c;
  @try {
    IOSByteArray *bytes = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(self, @"2.5.29.19");
    if (bytes != nil) {
  ...
  @try {
    IOSByteArray *bytes = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(self, @"2.5.29.15");
    if (bytes != nil) {
...
LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *new_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509X509Certificate_(id<LibOrgBouncycastleJcajceUtilJcaJceHelper> bcHelper, LibOrgBouncycastleAsn1X509X509Certificate *c) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509X509Certificate_, bcHelper, c)
}
...
LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *create_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509X509Certificate_(id<LibOrgBouncycastleJcajceUtilJcaJceHelper> bcHelper, LibOrgBouncycastleAsn1X509X509Certificate *c) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject, initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509X509Certificate_, bcHelper, c)
}

IOSByteArray *LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getExtensionBytesWithNSString_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *self, NSString *oid) {
...
void LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_checkSignatureWithJavaSecurityPublicKey_withJavaSecuritySignature_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject *self, id<JavaSecurityPublicKey> key, JavaSecuritySignature *signature) {
  if (!LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_isAlgIdEqualWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier_withLibOrgBouncycastleAsn1X509AlgorithmIdentifier_(self, [((LibOrgBouncycastleAsn1X509X509Certificate *) nil_chk(self->c_)) getSignatureAlgorithm], [((LibOrgBouncycastleAsn1X509TBSCertificate *) nil_chk([((LibOrgBouncycastleAsn1X509X509Certificate *) nil_chk(self->c_)) getTBSCertificate])) getSignature])) {
...
id<JavaUtilCollection> LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_getAlternativeNamesWithByteArray_(IOSByteArray *extVal) {
  LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject_initialize();
  if (extVal == nil) {
    return nil;
  }
  @try {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CertificateObject)
