...
//  source: ../android/src/main/kotlin/lib/org/bouncycastle/pqc/jcajce/provider/xmss/XMSSMTKeyFactorySpi.java
//
...
@implementation LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi_init(self);
  return self;
}
...
- (id<JavaSecuritySpecKeySpec>)engineGetKeySpecWithJavaSecurityKey:(id<JavaSecurityKey>)key
  ...
  if ([key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSMTPrivateKey class]]) {
  ...
  else if ([key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSMTPublicKey class]]) {
...
- (id<JavaSecurityKey>)engineTranslateKeyWithJavaSecurityKey:(id<JavaSecurityKey>)key {
  if ([key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSMTPrivateKey class]] || [key isKindOfClass:[LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSMTPublicKey class]]) {
    return key;
  }
...
- (id<JavaSecurityPrivateKey>)generatePrivateWithLibOrgBouncycastleAsn1PkcsPrivateKeyInfo:(LibOrgBouncycastleAsn1PkcsPrivateKeyInfo *)keyInfo {
  return new_LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSMTPrivateKey_initWithLibOrgBouncycastleAsn1PkcsPrivateKeyInfo_(keyInfo);
}
...
- (id<JavaSecurityPublicKey>)generatePublicWithLibOrgBouncycastleAsn1X509SubjectPublicKeyInfo:(LibOrgBouncycastleAsn1X509SubjectPublicKeyInfo *)keyInfo {
  return new_LibOrgBouncycastlePqcJcajceProviderXmssBCXMSSMTPublicKey_initWithLibOrgBouncycastleAsn1X509SubjectPublicKeyInfo_(keyInfo);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi = { "XMSSMTKeyFactorySpi", "lib.org.bouncycastle.pqc.jcajce.provider.xmss", ptrTable, methods, NULL, 7, 0x1, 7, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi;
}

@end

void LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi_init(LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi *self) {
  JavaSecurityKeyFactorySpi_init(self);
}

LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi *new_LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi, init)
}

LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi *create_LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastlePqcJcajceProviderXmssXMSSMTKeyFactorySpi)
