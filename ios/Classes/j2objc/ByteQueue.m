...
@interface LibOrgBouncycastleCryptoTlsByteQueue () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoTlsByteQueue, databuf_, IOSByteArray *)

inline jint LibOrgBouncycastleCryptoTlsByteQueue_get_DEFAULT_CAPACITY(void);
#define LibOrgBouncycastleCryptoTlsByteQueue_DEFAULT_CAPACITY 1024
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoTlsByteQueue, DEFAULT_CAPACITY, jint)

@implementation LibOrgBouncycastleCryptoTlsByteQueue

+ (jint)nextTwoPowWithInt:(jint)i {
  return LibOrgBouncycastleCryptoTlsByteQueue_nextTwoPowWithInt_(i);
}

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoTlsByteQueue_init(self);
  return self;
}
J2OBJC_IGNORE_DESIGNATED_END

- (instancetype)initWithInt:(jint)capacity {
  LibOrgBouncycastleCryptoTlsByteQueue_initWithInt_(self, capacity);
  return self;
}
...
- (instancetype)initWithByteArray:(IOSByteArray *)buf
                          withInt:(jint)off
                          withInt:(jint)len {
  LibOrgBouncycastleCryptoTlsByteQueue_initWithByteArray_withInt_withInt_(self, buf, off, len);
  return self;
}
...
- (void)addDataWithByteArray:(IOSByteArray *)buf
  ...
  if ((skipped_ + available_ + len) > ((IOSByteArray *) nil_chk(databuf_))->size_) {
    jint desiredSize = LibOrgBouncycastleCryptoTlsByteQueue_nextTwoPowWithInt_(available_ + len);
...
- (void)shrink {
  if (available_ == 0) {
    databuf_ = JreLoadStatic(LibOrgBouncycastleCryptoTlsTlsUtils, EMPTY_BYTES);
    skipped_ = 0;
  }
  else {
    jint desiredSize = LibOrgBouncycastleCryptoTlsByteQueue_nextTwoPowWithInt_(available_);
    if (desiredSize < ((IOSByteArray *) nil_chk(databuf_))->size_) {
      IOSByteArray *tmp = [IOSByteArray newArrayWithLength:desiredSize];
      JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(databuf_, skipped_, tmp, 0, available_);
      databuf_ = tmp;
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "DEFAULT_CAPACITY", "I", .constantValue.asInt = LibOrgBouncycastleCryptoTlsByteQueue_DEFAULT_CAPACITY, 0x1a, -1, -1, -1, -1 },
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoTlsByteQueue = { "ByteQueue", "lib.org.bouncycastle.crypto.tls", ptrTable, methods, fields, 7, 0x1, 13, 5, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoTlsByteQueue;
}

@end

jint LibOrgBouncycastleCryptoTlsByteQueue_nextTwoPowWithInt_(jint i) {
  LibOrgBouncycastleCryptoTlsByteQueue_initialize();
  i |= (JreRShift32(i, 1));
  i |= (JreRShift32(i, 2));
  i |= (JreRShift32(i, 4));
  i |= (JreRShift32(i, 8));
...
void LibOrgBouncycastleCryptoTlsByteQueue_init(LibOrgBouncycastleCryptoTlsByteQueue *self) {
  LibOrgBouncycastleCryptoTlsByteQueue_initWithInt_(self, LibOrgBouncycastleCryptoTlsByteQueue_DEFAULT_CAPACITY);
}

LibOrgBouncycastleCryptoTlsByteQueue *new_LibOrgBouncycastleCryptoTlsByteQueue_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoTlsByteQueue, init)
}

LibOrgBouncycastleCryptoTlsByteQueue *create_LibOrgBouncycastleCryptoTlsByteQueue_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoTlsByteQueue, init)
}

void LibOrgBouncycastleCryptoTlsByteQueue_initWithInt_(LibOrgBouncycastleCryptoTlsByteQueue *self, jint capacity) {
  NSObject_init(self);
  self->skipped_ = 0;
  self->available_ = 0;
  self->readOnlyBuf_ = false;
  self->databuf_ = capacity == 0 ? JreLoadStatic(LibOrgBouncycastleCryptoTlsTlsUtils, EMPTY_BYTES) : [IOSByteArray newArrayWithLength:capacity];
}

LibOrgBouncycastleCryptoTlsByteQueue *new_LibOrgBouncycastleCryptoTlsByteQueue_initWithInt_(jint capacity) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoTlsByteQueue, initWithInt_, capacity)
}

LibOrgBouncycastleCryptoTlsByteQueue *create_LibOrgBouncycastleCryptoTlsByteQueue_initWithInt_(jint capacity) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoTlsByteQueue, initWithInt_, capacity)
}

void LibOrgBouncycastleCryptoTlsByteQueue_initWithByteArray_withInt_withInt_(LibOrgBouncycastleCryptoTlsByteQueue *self, IOSByteArray *buf, jint off, jint len) {
  NSObject_init(self);
  self->skipped_ = 0;
  self->available_ = 0;
  self->readOnlyBuf_ = false;
...
LibOrgBouncycastleCryptoTlsByteQueue *new_LibOrgBouncycastleCryptoTlsByteQueue_initWithByteArray_withInt_withInt_(IOSByteArray *buf, jint off, jint len) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoTlsByteQueue, initWithByteArray_withInt_withInt_, buf, off, len)
}

LibOrgBouncycastleCryptoTlsByteQueue *create_LibOrgBouncycastleCryptoTlsByteQueue_initWithByteArray_withInt_withInt_(IOSByteArray *buf, jint off, jint len) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoTlsByteQueue, initWithByteArray_withInt_withInt_, buf, off, len)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoTlsByteQueue)
