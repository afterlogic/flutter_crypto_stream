...
@interface LibOrgBouncycastleCryptoEnginesCAST6Engine () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesCAST6Engine, _workingKey_CAST6Engine_, IOSIntArray *)

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesCAST6Engine_CAST_EncipherWithInt_withInt_withInt_withInt_withIntArray_(LibOrgBouncycastleCryptoEnginesCAST6Engine *self, jint A, jint B, jint C, jint D, IOSIntArray *result);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesCAST6Engine_CAST_DecipherWithInt_withInt_withInt_withInt_withIntArray_(LibOrgBouncycastleCryptoEnginesCAST6Engine *self, jint A, jint B, jint C, jint D, IOSIntArray *result);

@implementation LibOrgBouncycastleCryptoEnginesCAST6Engine

+ (jint)ROUNDS {
  return LibOrgBouncycastleCryptoEnginesCAST6Engine_ROUNDS;
}

+ (jint)BLOCK_SIZE {
  return LibOrgBouncycastleCryptoEnginesCAST6Engine_BLOCK_SIZE;
}

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesCAST6Engine_init(self);
  return self;
}
...
- (jint)encryptBlockWithByteArray:(IOSByteArray *)src
  ...
  LibOrgBouncycastleCryptoEnginesCAST6Engine_CAST_EncipherWithInt_withInt_withInt_withInt_withIntArray_(self, A, B, C, D, result);
...
- (jint)decryptBlockWithByteArray:(IOSByteArray *)src
  ...
  jint C = [self BytesTo32bitsWithByteArray:src withInt:srcIndex + 8];
  jint D = [self BytesTo32bitsWithByteArray:src withInt:srcIndex + 12];
  LibOrgBouncycastleCryptoEnginesCAST6Engine_CAST_DecipherWithInt_withInt_withInt_withInt_withIntArray_(self, A, B, C, D, result);
  [self Bits32ToBytesWithInt:IOSIntArray_Get(result, 0) withByteArray:dst withInt:dstIndex];
  [self Bits32ToBytesWithInt:IOSIntArray_Get(result, 1) withByteArray:dst withInt:dstIndex + 4];
  [self Bits32ToBytesWithInt:IOSIntArray_Get(result, 2) withByteArray:dst withInt:dstIndex + 8];
  [self Bits32ToBytesWithInt:IOSIntArray_Get(result, 3) withByteArray:dst withInt:dstIndex + 12];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "ROUNDS", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesCAST6Engine_ROUNDS, 0x1c, -1, -1, -1, -1 },
    { "BLOCK_SIZE", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesCAST6Engine_BLOCK_SIZE, 0x1c, -1, -1, -1, -1 },
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoEnginesCAST6Engine = { "CAST6Engine", "lib.org.bouncycastle.crypto.engines", ptrTable, methods, fields, 7, 0x11, 9, 7, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoEnginesCAST6Engine;
}

@end

void LibOrgBouncycastleCryptoEnginesCAST6Engine_init(LibOrgBouncycastleCryptoEnginesCAST6Engine *self) {
  LibOrgBouncycastleCryptoEnginesCAST5Engine_init(self);
  self->_Kr_CAST6Engine_ = [IOSIntArray newArrayWithLength:LibOrgBouncycastleCryptoEnginesCAST6Engine_ROUNDS * 4];
  self->_Km_CAST6Engine_ = [IOSIntArray newArrayWithLength:LibOrgBouncycastleCryptoEnginesCAST6Engine_ROUNDS * 4];
...
LibOrgBouncycastleCryptoEnginesCAST6Engine *new_LibOrgBouncycastleCryptoEnginesCAST6Engine_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesCAST6Engine, init)
}

LibOrgBouncycastleCryptoEnginesCAST6Engine *create_LibOrgBouncycastleCryptoEnginesCAST6Engine_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesCAST6Engine, init)
}

void LibOrgBouncycastleCryptoEnginesCAST6Engine_CAST_EncipherWithInt_withInt_withInt_withInt_withIntArray_(LibOrgBouncycastleCryptoEnginesCAST6Engine *self, jint A, jint B, jint C, jint D, IOSIntArray *result) {
  jint x;
  for (jint i = 0; i < 6; i++) {
    x = i * 4;
...
void LibOrgBouncycastleCryptoEnginesCAST6Engine_CAST_DecipherWithInt_withInt_withInt_withInt_withIntArray_(LibOrgBouncycastleCryptoEnginesCAST6Engine *self, jint A, jint B, jint C, jint D, IOSIntArray *result) {
  jint x;
  for (jint i = 0; i < 6; i++) {
    x = (11 - i) * 4;
    C ^= [self F1WithInt:D withInt:IOSIntArray_Get(nil_chk(self->_Km_CAST6Engine_), x) withInt:IOSIntArray_Get(nil_chk(self->_Kr_CAST6Engine_), x)];
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesCAST6Engine)
