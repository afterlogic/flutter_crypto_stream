...
@interface LibOrgBouncycastleCryptoMacsVMPCMac () {
 @public
  jbyte g_;
  jbyte n_;
  IOSByteArray *P_;
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoMacsVMPCMac, P_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoMacsVMPCMac, T_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoMacsVMPCMac, workingIV_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoMacsVMPCMac, workingKey_, IOSByteArray *)

__attribute__((unused)) static void LibOrgBouncycastleCryptoMacsVMPCMac_initKeyWithByteArray_withByteArray_(LibOrgBouncycastleCryptoMacsVMPCMac *self, IOSByteArray *keyBytes, IOSByteArray *ivBytes);

@implementation LibOrgBouncycastleCryptoMacsVMPCMac

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoMacsVMPCMac_init(self);
  return self;
}
...
- (void)init__WithLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  ...
  LibOrgBouncycastleCryptoParamsKeyParameter *key = (LibOrgBouncycastleCryptoParamsKeyParameter *) cast_chk([((LibOrgBouncycastleCryptoParamsParametersWithIV *) nil_chk(ivParams)) getParameters], [LibOrgBouncycastleCryptoParamsKeyParameter class]);
...
- (void)initKeyWithByteArray:(IOSByteArray *)keyBytes
  ...
  LibOrgBouncycastleCryptoMacsVMPCMac_initKeyWithByteArray_withByteArray_(self, keyBytes, ivBytes);
}

- (void)reset {
  LibOrgBouncycastleCryptoMacsVMPCMac_initKeyWithByteArray_withByteArray_(self, self->workingKey_, self->workingIV_);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "doFinal", "[BI", "LLibOrgBouncycastleCryptoDataLengthException;LJavaLangIllegalStateException;", "init", "LLibOrgBouncycastleCryptoCipherParameters;", "LJavaLangIllegalArgumentException;", "initKey", "[B[B", "update", "B", "LJavaLangIllegalStateException;", "[BII" };
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoMacsVMPCMac = { "VMPCMac", "lib.org.bouncycastle.crypto.macs", ptrTable, methods, fields, 7, 0x1, 9, 11, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoMacsVMPCMac;
}

@end

void LibOrgBouncycastleCryptoMacsVMPCMac_init(LibOrgBouncycastleCryptoMacsVMPCMac *self) {
  NSObject_init(self);
  self->n_ = 0;
  self->P_ = nil;
  self->s_ = 0;
...
LibOrgBouncycastleCryptoMacsVMPCMac *new_LibOrgBouncycastleCryptoMacsVMPCMac_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoMacsVMPCMac, init)
}

LibOrgBouncycastleCryptoMacsVMPCMac *create_LibOrgBouncycastleCryptoMacsVMPCMac_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoMacsVMPCMac, init)
}

void LibOrgBouncycastleCryptoMacsVMPCMac_initKeyWithByteArray_withByteArray_(LibOrgBouncycastleCryptoMacsVMPCMac *self, IOSByteArray *keyBytes, IOSByteArray *ivBytes) {
  self->s_ = 0;
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoMacsVMPCMac)
