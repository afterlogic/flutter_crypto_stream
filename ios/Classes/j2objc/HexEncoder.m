...
@interface LibOrgBouncycastleUtilEncodersHexEncoder ()

+ (jboolean)ignoreWithChar:(jchar)c;

@end

__attribute__((unused)) static jboolean LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_(jchar c);

@implementation LibOrgBouncycastleUtilEncodersHexEncoder
...
- (instancetype)init {
  LibOrgBouncycastleUtilEncodersHexEncoder_init(self);
  return self;
}
...
+ (jboolean)ignoreWithChar:(jchar)c {
  return LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_(c);
}
...
- (jint)decodeWithByteArray:(IOSByteArray *)data
  ...
  jint end = off + length;
  while (end > off) {
    if (!LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_((jchar) IOSByteArray_Get(nil_chk(data), end - 1))) {
      break;
    }
    end--;
  }
  jint i = off;
  while (i < end) {
    while (i < end && LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_((jchar) IOSByteArray_Get(nil_chk(data), i))) {
      i++;
    }
    b1 = IOSByteArray_Get(nil_chk(decodingTable_), IOSByteArray_Get(nil_chk(data), i++));
    while (i < end && LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_((jchar) IOSByteArray_Get(data, i))) {
      i++;
    }
...
- (jint)decodeWithNSString:(NSString *)data
  ...
  while (end > 0) {
    if (!LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_([data charAtWithInt:end - 1])) {
      break;
    }
    end--;
  }
  jint i = 0;
  while (i < end) {
    while (i < end && LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_([data charAtWithInt:i])) {
      i++;
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleUtilEncodersHexEncoder = { "HexEncoder", "lib.org.bouncycastle.util.encoders", ptrTable, methods, fields, 7, 0x1, 6, 2, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleUtilEncodersHexEncoder;
}

@end

void LibOrgBouncycastleUtilEncodersHexEncoder_init(LibOrgBouncycastleUtilEncodersHexEncoder *self) {
  NSObject_init(self);
...
LibOrgBouncycastleUtilEncodersHexEncoder *new_LibOrgBouncycastleUtilEncodersHexEncoder_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleUtilEncodersHexEncoder, init)
}

LibOrgBouncycastleUtilEncodersHexEncoder *create_LibOrgBouncycastleUtilEncodersHexEncoder_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleUtilEncodersHexEncoder, init)
}

jboolean LibOrgBouncycastleUtilEncodersHexEncoder_ignoreWithChar_(jchar c) {
  LibOrgBouncycastleUtilEncodersHexEncoder_initialize();
  return c == 0x000a || c == 0x000d || c == 0x0009 || c == ' ';
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleUtilEncodersHexEncoder)
