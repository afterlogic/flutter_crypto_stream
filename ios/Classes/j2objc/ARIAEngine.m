...
@interface LibOrgBouncycastleCryptoEnginesARIAEngine () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesARIAEngine, roundKeys_, IOSObjectArray *)

inline IOSObjectArray *LibOrgBouncycastleCryptoEnginesARIAEngine_get_C(void);
static IOSObjectArray *LibOrgBouncycastleCryptoEnginesARIAEngine_C;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesARIAEngine, C, IOSObjectArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_get_SB1_sbox(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_SB1_sbox;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesARIAEngine, SB1_sbox, IOSByteArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_get_SB2_sbox(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_SB2_sbox;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesARIAEngine, SB2_sbox, IOSByteArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_get_SB3_sbox(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_SB3_sbox;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesARIAEngine, SB3_sbox, IOSByteArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_get_SB4_sbox(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesARIAEngine_SB4_sbox;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesARIAEngine, SB4_sbox, IOSByteArray *)

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesARIAEngine)

@implementation LibOrgBouncycastleCryptoEnginesARIAEngine

+ (jint)BLOCK_SIZE {
  return LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE;
}

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesARIAEngine_init(self);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  if (!([params isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]])) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"invalid parameter passed to ARIA init - ", [[((id<LibOrgBouncycastleCryptoCipherParameters>) nil_chk(params)) java_getClass] getName]));
  }
  self->roundKeys_ = LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleWithBoolean_withByteArray_(forEncryption, [((LibOrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((LibOrgBouncycastleCryptoParamsKeyParameter *) cast_chk(params, [LibOrgBouncycastleCryptoParamsKeyParameter class])))) getKey]);
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if (inOff > (((IOSByteArray *) nil_chk(inArg))->size_ - LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE)) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if (outOff > (((IOSByteArray *) nil_chk(outArg))->size_ - LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE)) {
    @throw new_LibOrgBouncycastleCryptoOutputLengthException_initWithNSString_(@"output buffer too short");
  }
  IOSByteArray *z = [IOSByteArray newArrayWithLength:LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE];
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(inArg, inOff, z, 0, LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE);
  jint i = 0;
  jint rounds = ((IOSObjectArray *) nil_chk(roundKeys_))->size_ - 3;
  while (i < rounds) {
    LibOrgBouncycastleCryptoEnginesARIAEngine_FOWithByteArray_withByteArray_(z, IOSObjectArray_Get(nil_chk(roundKeys_), i++));
    LibOrgBouncycastleCryptoEnginesARIAEngine_FEWithByteArray_withByteArray_(z, IOSObjectArray_Get(nil_chk(roundKeys_), i++));
  }
  LibOrgBouncycastleCryptoEnginesARIAEngine_FOWithByteArray_withByteArray_(z, IOSObjectArray_Get(nil_chk(roundKeys_), i++));
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(z, IOSObjectArray_Get(nil_chk(roundKeys_), i++));
  LibOrgBouncycastleCryptoEnginesARIAEngine_SL2WithByteArray_(z);
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(z, IOSObjectArray_Get(nil_chk(roundKeys_), i));
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(z, 0, outArg, outOff, LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE);
  return LibOrgBouncycastleCryptoEnginesARIAEngine_BLOCK_SIZE;
}
...
+ (void)AWithByteArray:(IOSByteArray *)z {
  LibOrgBouncycastleCryptoEnginesARIAEngine_AWithByteArray_(z);
}

+ (void)FEWithByteArray:(IOSByteArray *)D
          withByteArray:(IOSByteArray *)RK {
  LibOrgBouncycastleCryptoEnginesARIAEngine_FEWithByteArray_withByteArray_(D, RK);
}

+ (void)FOWithByteArray:(IOSByteArray *)D
          withByteArray:(IOSByteArray *)RK {
  LibOrgBouncycastleCryptoEnginesARIAEngine_FOWithByteArray_withByteArray_(D, RK);
}

+ (IOSObjectArray *)keyScheduleWithBoolean:(jboolean)forEncryption
                             withByteArray:(IOSByteArray *)K {
  return LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleWithBoolean_withByteArray_(forEncryption, K);
}
...
+ (void)keyScheduleRoundWithByteArray:(IOSByteArray *)rk
                        ...
                        withByteArray:(IOSByteArray *)wr
                              withInt:(jint)n {
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(rk, w, wr, n);
}

+ (void)reverseKeysWithByteArray2:(IOSObjectArray *)keys {
  LibOrgBouncycastleCryptoEnginesARIAEngine_reverseKeysWithByteArray2_(keys);
}

+ (jbyte)SB1WithByte:(jbyte)x {
  return LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(x);
}

+ (jbyte)SB2WithByte:(jbyte)x {
  return LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(x);
}

+ (jbyte)SB3WithByte:(jbyte)x {
  return LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(x);
}

+ (jbyte)SB4WithByte:(jbyte)x {
  return LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(x);
}

+ (void)SL1WithByteArray:(IOSByteArray *)z {
  LibOrgBouncycastleCryptoEnginesARIAEngine_SL1WithByteArray_(z);
}
...
+ (void)xor__WithByteArray:(IOSByteArray *)z
  ...
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(z, x);
}
...
void LibOrgBouncycastleCryptoEnginesARIAEngine_FEWithByteArray_withByteArray_(IOSByteArray *D, IOSByteArray *RK) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(D, RK);
  LibOrgBouncycastleCryptoEnginesARIAEngine_SL2WithByteArray_(D);
  LibOrgBouncycastleCryptoEnginesARIAEngine_AWithByteArray_(D);
}

void LibOrgBouncycastleCryptoEnginesARIAEngine_FOWithByteArray_withByteArray_(IOSByteArray *D, IOSByteArray *RK) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(D, RK);
  LibOrgBouncycastleCryptoEnginesARIAEngine_SL1WithByteArray_(D);
  LibOrgBouncycastleCryptoEnginesARIAEngine_AWithByteArray_(D);
}

IOSObjectArray *LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleWithBoolean_withByteArray_(jboolean forEncryption, IOSByteArray *K) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  ...
  IOSByteArray *CK1 = IOSObjectArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesARIAEngine_C), keyLenIdx);
  IOSByteArray *CK2 = IOSObjectArray_Get(LibOrgBouncycastleCryptoEnginesARIAEngine_C, (keyLenIdx + 1) % 3);
  IOSByteArray *CK3 = IOSObjectArray_Get(LibOrgBouncycastleCryptoEnginesARIAEngine_C, (keyLenIdx + 2) % 3);
  ...
  LibOrgBouncycastleCryptoEnginesARIAEngine_FOWithByteArray_withByteArray_(W1, CK1);
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(W1, KR);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(W1, 0, W2, 0, 16);
  LibOrgBouncycastleCryptoEnginesARIAEngine_FEWithByteArray_withByteArray_(W2, CK2);
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(W2, W0);
  JavaLangSystem_arraycopyWithId_withInt_withId_withInt_withInt_(W2, 0, W3, 0, 16);
  LibOrgBouncycastleCryptoEnginesARIAEngine_FOWithByteArray_withByteArray_(W3, CK3);
  LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(W3, W1);
  jint numRounds = 12 + (keyLenIdx * 2);
  IOSObjectArray *rks = [IOSByteArray newArrayWithDimensions:2 lengths:(jint[]){ numRounds + 1, 16 }];
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 0), W0, W1, 19);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 1), W1, W2, 19);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 2), W2, W3, 19);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 3), W3, W0, 19);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 4), W0, W1, 31);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 5), W1, W2, 31);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 6), W2, W3, 31);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 7), W3, W0, 31);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 8), W0, W1, 67);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 9), W1, W2, 67);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 10), W2, W3, 67);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 11), W3, W0, 67);
  LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 12), W0, W1, 97);
  if (numRounds > 12) {
    LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 13), W1, W2, 97);
    LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 14), W2, W3, 97);
    if (numRounds > 14) {
      LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 15), W3, W0, 97);
      LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSObjectArray_Get(rks, 16), W0, W1, 109);
    }
  }
  if (!forEncryption) {
    LibOrgBouncycastleCryptoEnginesARIAEngine_reverseKeysWithByteArray2_(rks);
    for (jint i = 1; i < numRounds; ++i) {
      LibOrgBouncycastleCryptoEnginesARIAEngine_AWithByteArray_(IOSObjectArray_Get(rks, i));
    }
  }
  return rks;
}

void LibOrgBouncycastleCryptoEnginesARIAEngine_keyScheduleRoundWithByteArray_withByteArray_withByteArray_withInt_(IOSByteArray *rk, IOSByteArray *w, IOSByteArray *wr, jint n) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
...
void LibOrgBouncycastleCryptoEnginesARIAEngine_reverseKeysWithByteArray2_(IOSObjectArray *keys) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
...
jbyte LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(jbyte x) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  return IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesARIAEngine_SB1_sbox), x & (jint) 0xFF);
}

jbyte LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(jbyte x) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  return IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesARIAEngine_SB2_sbox), x & (jint) 0xFF);
}

jbyte LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(jbyte x) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  return IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesARIAEngine_SB3_sbox), x & (jint) 0xFF);
}

jbyte LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(jbyte x) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  return IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesARIAEngine_SB4_sbox), x & (jint) 0xFF);
}

void LibOrgBouncycastleCryptoEnginesARIAEngine_SL1WithByteArray_(IOSByteArray *z) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  *IOSByteArray_GetRef(nil_chk(z), 0) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 0));
  *IOSByteArray_GetRef(z, 1) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 1));
  *IOSByteArray_GetRef(z, 2) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 2));
  *IOSByteArray_GetRef(z, 3) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 3));
  *IOSByteArray_GetRef(z, 4) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 4));
  *IOSByteArray_GetRef(z, 5) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 5));
  *IOSByteArray_GetRef(z, 6) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 6));
  *IOSByteArray_GetRef(z, 7) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 7));
  *IOSByteArray_GetRef(z, 8) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 8));
  *IOSByteArray_GetRef(z, 9) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 9));
  *IOSByteArray_GetRef(z, 10) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 10));
  *IOSByteArray_GetRef(z, 11) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 11));
  *IOSByteArray_GetRef(z, 12) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 12));
  *IOSByteArray_GetRef(z, 13) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 13));
  *IOSByteArray_GetRef(z, 14) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 14));
  *IOSByteArray_GetRef(z, 15) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 15));
}

void LibOrgBouncycastleCryptoEnginesARIAEngine_SL2WithByteArray_(IOSByteArray *z) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  *IOSByteArray_GetRef(nil_chk(z), 0) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 0));
  *IOSByteArray_GetRef(z, 1) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 1));
  *IOSByteArray_GetRef(z, 2) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 2));
  *IOSByteArray_GetRef(z, 3) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 3));
  *IOSByteArray_GetRef(z, 4) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 4));
  *IOSByteArray_GetRef(z, 5) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 5));
  *IOSByteArray_GetRef(z, 6) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 6));
  *IOSByteArray_GetRef(z, 7) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 7));
  *IOSByteArray_GetRef(z, 8) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 8));
  *IOSByteArray_GetRef(z, 9) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 9));
  *IOSByteArray_GetRef(z, 10) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 10));
  *IOSByteArray_GetRef(z, 11) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 11));
  *IOSByteArray_GetRef(z, 12) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB3WithByte_(IOSByteArray_Get(z, 12));
  *IOSByteArray_GetRef(z, 13) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB4WithByte_(IOSByteArray_Get(z, 13));
  *IOSByteArray_GetRef(z, 14) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB1WithByte_(IOSByteArray_Get(z, 14));
  *IOSByteArray_GetRef(z, 15) = LibOrgBouncycastleCryptoEnginesARIAEngine_SB2WithByte_(IOSByteArray_Get(z, 15));
}

void LibOrgBouncycastleCryptoEnginesARIAEngine_xor__WithByteArray_withByteArray_(IOSByteArray *z, IOSByteArray *x) {
  LibOrgBouncycastleCryptoEnginesARIAEngine_initialize();
  for (jint i = 0; i < 16; ++i) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesARIAEngine)
