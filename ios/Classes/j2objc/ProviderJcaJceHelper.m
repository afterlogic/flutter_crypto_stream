...
@implementation LibOrgBouncycastleJcajceUtilProviderJcaJceHelper

- (instancetype)initWithJavaSecurityProvider:(JavaSecurityProvider *)provider {
  LibOrgBouncycastleJcajceUtilProviderJcaJceHelper_initWithJavaSecurityProvider_(self, provider);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleJcajceUtilProviderJcaJceHelper = { "ProviderJcaJceHelper", "lib.org.bouncycastle.jcajce.util", ptrTable, methods, fields, 7, 0x1, 14, 1, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJcajceUtilProviderJcaJceHelper;
}

@end

void LibOrgBouncycastleJcajceUtilProviderJcaJceHelper_initWithJavaSecurityProvider_(LibOrgBouncycastleJcajceUtilProviderJcaJceHelper *self, JavaSecurityProvider *provider) {
  NSObject_init(self);
  self->provider_ = provider;
}

LibOrgBouncycastleJcajceUtilProviderJcaJceHelper *new_LibOrgBouncycastleJcajceUtilProviderJcaJceHelper_initWithJavaSecurityProvider_(JavaSecurityProvider *provider) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJcajceUtilProviderJcaJceHelper, initWithJavaSecurityProvider_, provider)
}

LibOrgBouncycastleJcajceUtilProviderJcaJceHelper *create_LibOrgBouncycastleJcajceUtilProviderJcaJceHelper_initWithJavaSecurityProvider_(JavaSecurityProvider *provider) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJcajceUtilProviderJcaJceHelper, initWithJavaSecurityProvider_, provider)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJcajceUtilProviderJcaJceHelper)
