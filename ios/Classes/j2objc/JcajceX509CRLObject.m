...
@interface LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject, bcHelper_, id<LibOrgBouncycastleJcajceUtilJcaJceHelper>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject, c_, LibOrgBouncycastleAsn1X509CertificateList *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject, sigAlgName_, NSString *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject, sigAlgParams_, IOSByteArray *)

__attribute__((unused)) static id<JavaUtilSet> LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_getExtensionOIDsWithBoolean_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self, jboolean critical);

__attribute__((unused)) static void LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_doVerifyWithJavaSecurityPublicKey_withJavaSecuritySignature_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self, id<JavaSecurityPublicKey> key, JavaSecuritySignature *sig);

__attribute__((unused)) static id<JavaUtilSet> LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_loadCRLEntries(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self);

@implementation LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject

+ (jboolean)isIndirectCRLWithJavaSecurityCertX509CRL:(JavaSecurityCertX509CRL *)crl {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_isIndirectCRLWithJavaSecurityCertX509CRL_(crl);
}
...
- (instancetype)initWithLibOrgBouncycastleJcajceUtilJcaJceHelper:(id<LibOrgBouncycastleJcajceUtilJcaJceHelper>)bcHelper
  ...
  LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509CertificateList_(self, bcHelper, c);
  return self;
}
...
- (jboolean)hasUnsupportedCriticalExtension {
  ...
  [extns removeWithId:[((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, issuingDistributionPoint))) getId]];
  [extns removeWithId:[((LibOrgBouncycastleAsn1ASN1ObjectIdentifier *) nil_chk(JreLoadStatic(LibOrgBouncycastleAsn1X509Extension, deltaCRLIndicator))) getId]];
  return ![extns isEmpty];
}

- (id<JavaUtilSet>)getExtensionOIDsWithBoolean:(jboolean)critical {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_getExtensionOIDsWithBoolean_(self, critical);
}

- (id<JavaUtilSet>)getCriticalExtensionOIDs {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_getExtensionOIDsWithBoolean_(self, true);
}

- (id<JavaUtilSet>)getNonCriticalExtensionOIDs {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_getExtensionOIDsWithBoolean_(self, false);
}
...
- (void)verifyWithJavaSecurityPublicKey:(id<JavaSecurityPublicKey>)key {
  ...
  @try {
    sig = [((id<LibOrgBouncycastleJcajceUtilJcaJceHelper>) nil_chk(bcHelper_)) createSignatureWithNSString:[self getSigAlgName]];
  }
  @catch (JavaLangException *e) {
    sig = JavaSecuritySignature_getInstanceWithNSString_([self getSigAlgName]);
  }
  LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_doVerifyWithJavaSecurityPublicKey_withJavaSecuritySignature_(self, key, sig);
}
...
- (id<JavaUtilSet>)loadCRLEntries {
  return LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_loadCRLEntries(self);
}
...
- (JavaSecurityCertX509CRLEntry *)getRevokedCertificateWithJavaMathBigInteger:(JavaMathBigInteger *)serialNumber {
  ...
  while ([((id<JavaUtilEnumeration>) nil_chk(certs)) hasMoreElements]) {
    ...
    if ([((JavaMathBigInteger *) nil_chk(serialNumber)) isEqual:[((LibOrgBouncycastleAsn1ASN1Integer *) nil_chk([((LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *) nil_chk(entry_)) getUserCertificate])) getValue]]) {
      return new_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_(entry_, isIndirect_, previousCertificateIssuer);
    }
...
- (id<JavaUtilSet>)getRevokedCertificates {
  id<JavaUtilSet> entrySet = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_loadCRLEntries(self);
...
- (jboolean)isEqual:(id)other {
  ...
  if ([other isKindOfClass:[LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject class]]) {
    LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *crlObject = (LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *) other;
    if (isHashCodeSet_) {
      jboolean otherIsHashCodeSet = ((LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *) nil_chk(crlObject))->isHashCodeSet_;
    ...
    return [((LibOrgBouncycastleAsn1X509CertificateList *) nil_chk(self->c_)) isEqual:((LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *) nil_chk(crlObject))->c_];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[1].selector = @selector(initWithLibOrgBouncycastleJcajceUtilJcaJceHelper:withLibOrgBouncycastleAsn1X509CertificateList:);
  ...
  static const void *ptrTable[] = { "isIndirectCRL", "LJavaSecurityCertX509CRL;", "LJavaSecurityCertCRLException;", "LLibOrgBouncycastleJcajceUtilJcaJceHelper;LLibOrgBouncycastleAsn1X509CertificateList;", "getExtensionOIDs", "Z", "getExtensionValue", "LNSString;", "verify", "LJavaSecurityPublicKey;", "LJavaSecurityCertCRLException;LJavaSecurityNoSuchAlgorithmException;LJavaSecurityInvalidKeyException;LJavaSecurityNoSuchProviderException;LJavaSecuritySignatureException;", "LJavaSecurityPublicKey;LNSString;", "LJavaSecurityPublicKey;LJavaSecurityProvider;", "LJavaSecurityCertCRLException;LJavaSecurityNoSuchAlgorithmException;LJavaSecurityInvalidKeyException;LJavaSecuritySignatureException;", "doVerify", "LJavaSecurityPublicKey;LJavaSecuritySignature;", "getRevokedCertificate", "LJavaMathBigInteger;", "toString", "isRevoked", "LJavaSecurityCertCertificate;", "equals", "LNSObject;", "hashCode" };
  static const J2ObjcClassInfo _LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject = { "JcajceX509CRLObject", "lib.org.bouncycastle.jcajce.provider.asymmetric.x509", ptrTable, methods, fields, 7, 0x0, 29, 7, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject;
}

@end

jboolean LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_isIndirectCRLWithJavaSecurityCertX509CRL_(JavaSecurityCertX509CRL *crl) {
  LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_initialize();
  @try {
  ...
  @catch (JavaLangException *e) {
    @throw new_LibOrgBouncycastleJcajceProviderAsymmetricX509X509ExtCRLException_initWithNSString_withJavaLangThrowable_(@"Exception reading IssuingDistributionPoint", e);
  }
}
...
void LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509CertificateList_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self, id<LibOrgBouncycastleJcajceUtilJcaJceHelper> bcHelper, LibOrgBouncycastleAsn1X509CertificateList *c) {
  ...
  self->c_ = c;
  @try {
    self->sigAlgName_ = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509SignatureUtil_getSignatureNameWithLibOrgBouncycastleAsn1X509AlgorithmIdentifier_([((LibOrgBouncycastleAsn1X509CertificateList *) nil_chk(c)) getSignatureAlgorithm]);
    ...
    self->isIndirect_ = LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_isIndirectCRLWithJavaSecurityCertX509CRL_(self);
  }
  @catch (JavaLangException *e) {
...
LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *new_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509CertificateList_(id<LibOrgBouncycastleJcajceUtilJcaJceHelper> bcHelper, LibOrgBouncycastleAsn1X509CertificateList *c) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject, initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509CertificateList_, bcHelper, c)
}

LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *create_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509CertificateList_(id<LibOrgBouncycastleJcajceUtilJcaJceHelper> bcHelper, LibOrgBouncycastleAsn1X509CertificateList *c) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject, initWithLibOrgBouncycastleJcajceUtilJcaJceHelper_withLibOrgBouncycastleAsn1X509CertificateList_, bcHelper, c)
}

id<JavaUtilSet> LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_getExtensionOIDsWithBoolean_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self, jboolean critical) {
...
void LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_doVerifyWithJavaSecurityPublicKey_withJavaSecuritySignature_(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self, id<JavaSecurityPublicKey> key, JavaSecuritySignature *sig) {
  ...
  if (self->sigAlgParams_ != nil) {
    @try {
      LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509SignatureUtil_setSignatureParametersWithJavaSecuritySignature_withLibOrgBouncycastleAsn1ASN1Encodable_(sig, LibOrgBouncycastleAsn1ASN1Primitive_fromByteArrayWithByteArray_(self->sigAlgParams_));
    }
    @catch (JavaIoIOException *e) {
...
id<JavaUtilSet> LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject_loadCRLEntries(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject *self) {
  ...
  while ([((id<JavaUtilEnumeration>) nil_chk(certs)) hasMoreElements]) {
    LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *entry_ = (LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry *) cast_chk([certs nextElement], [LibOrgBouncycastleAsn1X509TBSCertList_CRLEntry class]);
    LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLEntryObject *crlEntry = new_LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLEntryObject_initWithLibOrgBouncycastleAsn1X509TBSCertList_CRLEntry_withBoolean_withLibOrgBouncycastleAsn1X500X500Name_(entry_, self->isIndirect_, previousCertificateIssuer);
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleJcajceProviderAsymmetricX509JcajceX509CRLObject)
