...
@interface LibOrgBouncycastleI18nMissingEntryException () {
 @public
  NSString *debugMsg_;
}
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleI18nMissingEntryException, debugMsg_, NSString *)

@implementation LibOrgBouncycastleI18nMissingEntryException
...
- (instancetype)initWithNSString:(NSString *)message
  ...
  LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(self, message, resource, key, locale, loader);
  return self;
}
...
- (instancetype)initWithNSString:(NSString *)message
           withJavaLangThrowable:(JavaLangThrowable *)cause
              ...
              withJavaUtilLocale:(JavaUtilLocale *)locale
         withJavaLangClassLoader:(JavaLangClassLoader *)loader {
  LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withJavaLangThrowable_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(self, message, cause, resource, key, locale, loader);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleI18nMissingEntryException = { "MissingEntryException", "lib.org.bouncycastle.i18n", ptrTable, methods, fields, 7, 0x1, 7, 5, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleI18nMissingEntryException;
}

@end

void LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(LibOrgBouncycastleI18nMissingEntryException *self, NSString *message, NSString *resource, NSString *key, JavaUtilLocale *locale, JavaLangClassLoader *loader) {
...
LibOrgBouncycastleI18nMissingEntryException *new_LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(NSString *message, NSString *resource, NSString *key, JavaUtilLocale *locale, JavaLangClassLoader *loader) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleI18nMissingEntryException, initWithNSString_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_, message, resource, key, locale, loader)
}

LibOrgBouncycastleI18nMissingEntryException *create_LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(NSString *message, NSString *resource, NSString *key, JavaUtilLocale *locale, JavaLangClassLoader *loader) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleI18nMissingEntryException, initWithNSString_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_, message, resource, key, locale, loader)
}
...
LibOrgBouncycastleI18nMissingEntryException *new_LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withJavaLangThrowable_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(NSString *message, JavaLangThrowable *cause, NSString *resource, NSString *key, JavaUtilLocale *locale, JavaLangClassLoader *loader) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleI18nMissingEntryException, initWithNSString_withJavaLangThrowable_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_, message, cause, resource, key, locale, loader)
}
...
LibOrgBouncycastleI18nMissingEntryException *create_LibOrgBouncycastleI18nMissingEntryException_initWithNSString_withJavaLangThrowable_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_(NSString *message, JavaLangThrowable *cause, NSString *resource, NSString *key, JavaUtilLocale *locale, JavaLangClassLoader *loader) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleI18nMissingEntryException, initWithNSString_withJavaLangThrowable_withNSString_withNSString_withJavaUtilLocale_withJavaLangClassLoader_, message, cause, resource, key, locale, loader)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleI18nMissingEntryException)
