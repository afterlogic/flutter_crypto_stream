...
#include "RSAPrivateKeyStructure.h"
#include "java/lang/IllegalArgumentException.h"
#include "java/math/BigInteger.h"
#include "java/util/Enumeration.h"

@interface LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure () {
 @public
  jint version__;
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, modulus_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, publicExponent_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, privateExponent_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, prime1_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, prime2_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, exponent1_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, exponent2_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, coefficient_, JavaMathBigInteger *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, otherPrimeInfos_, LibOrgBouncycastleAsn1ASN1Sequence *)

@implementation LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure
...
+ (LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *)getInstanceWithLibOrgBouncycastleAsn1ASN1TaggedObject:(LibOrgBouncycastleAsn1ASN1TaggedObject *)obj
  ...
  return LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_getInstanceWithLibOrgBouncycastleAsn1ASN1TaggedObject_withBoolean_(obj, explicit_);
}

+ (LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *)getInstanceWithId:(id)obj {
  return LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_getInstanceWithId_(obj);
}
...
- (instancetype)initWithJavaMathBigInteger:(JavaMathBigInteger *)modulus
  ...
  LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_(self, modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient);
  return self;
}

- (instancetype)initWithLibOrgBouncycastleAsn1ASN1Sequence:(LibOrgBouncycastleAsn1ASN1Sequence *)seq {
  LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithLibOrgBouncycastleAsn1ASN1Sequence_(self, seq);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { NULL, "LLibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure;", 0x9, 0, 1, -1, -1, -1, -1 },
    { NULL, "LLibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure;", 0x9, 0, 2, -1, -1, -1, -1 },
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure = { "RSAPrivateKeyStructure", "lib.org.bouncycastle.asn1.pkcs", ptrTable, methods, fields, 7, 0x1, 14, 10, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure;
}

@end

LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_getInstanceWithLibOrgBouncycastleAsn1ASN1TaggedObject_withBoolean_(LibOrgBouncycastleAsn1ASN1TaggedObject *obj, jboolean explicit_) {
  LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initialize();
  return LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_getInstanceWithId_(LibOrgBouncycastleAsn1ASN1Sequence_getInstanceWithLibOrgBouncycastleAsn1ASN1TaggedObject_withBoolean_(obj, explicit_));
}

LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_getInstanceWithId_(id obj) {
  LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initialize();
  if ([obj isKindOfClass:[LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure class]]) {
    return (LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *) obj;
  }
  else if ([obj isKindOfClass:[LibOrgBouncycastleAsn1ASN1Sequence class]]) {
    return new_LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithLibOrgBouncycastleAsn1ASN1Sequence_((LibOrgBouncycastleAsn1ASN1Sequence *) obj);
  }
...
LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *new_LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_(JavaMathBigInteger *modulus, JavaMathBigInteger *publicExponent, JavaMathBigInteger *privateExponent, JavaMathBigInteger *prime1, JavaMathBigInteger *prime2, JavaMathBigInteger *exponent1, JavaMathBigInteger *exponent2, JavaMathBigInteger *coefficient) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_, modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient)
}

LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *create_LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_(JavaMathBigInteger *modulus, JavaMathBigInteger *publicExponent, JavaMathBigInteger *privateExponent, JavaMathBigInteger *prime1, JavaMathBigInteger *prime2, JavaMathBigInteger *exponent1, JavaMathBigInteger *exponent2, JavaMathBigInteger *coefficient) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, initWithJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_withJavaMathBigInteger_, modulus, publicExponent, privateExponent, prime1, prime2, exponent1, exponent2, coefficient)
}

void LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithLibOrgBouncycastleAsn1ASN1Sequence_(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *self, LibOrgBouncycastleAsn1ASN1Sequence *seq) {
  LibOrgBouncycastleAsn1ASN1Object_init(self);
  self->otherPrimeInfos_ = nil;
...
LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *new_LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithLibOrgBouncycastleAsn1ASN1Sequence_(LibOrgBouncycastleAsn1ASN1Sequence *seq) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, initWithLibOrgBouncycastleAsn1ASN1Sequence_, seq)
}

LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure *create_LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure_initWithLibOrgBouncycastleAsn1ASN1Sequence_(LibOrgBouncycastleAsn1ASN1Sequence *seq) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure, initWithLibOrgBouncycastleAsn1ASN1Sequence_, seq)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleAsn1PkcsRSAPrivateKeyStructure)
