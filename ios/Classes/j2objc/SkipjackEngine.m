...
@interface LibOrgBouncycastleCryptoEnginesSkipjackEngine () {
 @public
  IOSIntArray *key0_;
  IOSIntArray *key1_;
  IOSIntArray *key2_;
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesSkipjackEngine, key0_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesSkipjackEngine, key1_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesSkipjackEngine, key2_, IOSIntArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesSkipjackEngine, key3_, IOSIntArray *)

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSkipjackEngine_gWithInt_withInt_(LibOrgBouncycastleCryptoEnginesSkipjackEngine *self, jint k, jint w);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesSkipjackEngine_hWithInt_withInt_(LibOrgBouncycastleCryptoEnginesSkipjackEngine *self, jint k, jint w);

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesSkipjackEngine)

IOSShortArray *LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable;

@implementation LibOrgBouncycastleCryptoEnginesSkipjackEngine

+ (jint)BLOCK_SIZE {
  return LibOrgBouncycastleCryptoEnginesSkipjackEngine_BLOCK_SIZE;
}

+ (IOSShortArray *)ftable {
  return LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable;
}

+ (void)setFtable:(IOSShortArray *)value {
  LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable = value;
}

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesSkipjackEngine_init(self);
  return self;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  if (!([params isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]])) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"invalid parameter passed to SKIPJACK init - ", [[((id<LibOrgBouncycastleCryptoCipherParameters>) nil_chk(params)) java_getClass] getName]));
  }
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if ((inOff + LibOrgBouncycastleCryptoEnginesSkipjackEngine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(inArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if ((outOff + LibOrgBouncycastleCryptoEnginesSkipjackEngine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(outArg))->size_) {
...
- (jint)gWithInt:(jint)k
         withInt:(jint)w {
  return LibOrgBouncycastleCryptoEnginesSkipjackEngine_gWithInt_withInt_(self, k, w);
}
...
- (jint)encryptBlockWithByteArray:(IOSByteArray *)inArg
  ...
  for (jint t = 0; t < 2; t++) {
    for (jint i = 0; i < 8; i++) {
      ...
      w4 = w3;
      w3 = w2;
      w2 = LibOrgBouncycastleCryptoEnginesSkipjackEngine_gWithInt_withInt_(self, k, w1);
      w1 = w2 ^ tmp ^ (k + 1);
      k++;
    }
    for (jint i = 0; i < 8; i++) {
...
- (jint)hWithInt:(jint)k
         withInt:(jint)w {
  return LibOrgBouncycastleCryptoEnginesSkipjackEngine_hWithInt_withInt_(self, k, w);
}
...
- (jint)decryptBlockWithByteArray:(IOSByteArray *)inArg
  ...
  for (jint t = 0; t < 2; t++) {
    for (jint i = 0; i < 8; i++) {
      ...
      w4 = w3;
      w3 = w2;
      w2 = LibOrgBouncycastleCryptoEnginesSkipjackEngine_hWithInt_withInt_(self, k, w1);
      w1 = w2 ^ tmp ^ (k + 1);
      k--;
    }
    for (jint i = 0; i < 8; i++) {
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "BLOCK_SIZE", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesSkipjackEngine_BLOCK_SIZE, 0x18, -1, -1, -1, -1 },
...
jint LibOrgBouncycastleCryptoEnginesSkipjackEngine_gWithInt_withInt_(LibOrgBouncycastleCryptoEnginesSkipjackEngine *self, jint k, jint w) {
  ...
  g2 = w & (jint) 0xff;
  g3 = IOSShortArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable), g2 ^ IOSIntArray_Get(nil_chk(self->key0_), k)) ^ g1;
  g4 = IOSShortArray_Get(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable, g3 ^ IOSIntArray_Get(nil_chk(self->key1_), k)) ^ g2;
  g5 = IOSShortArray_Get(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable, g4 ^ IOSIntArray_Get(nil_chk(self->key2_), k)) ^ g3;
  g6 = IOSShortArray_Get(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable, g5 ^ IOSIntArray_Get(nil_chk(self->key3_), k)) ^ g4;
  return ((JreLShift32(g5, 8)) + g6);
}

jint LibOrgBouncycastleCryptoEnginesSkipjackEngine_hWithInt_withInt_(LibOrgBouncycastleCryptoEnginesSkipjackEngine *self, jint k, jint w) {
  jint h1;
  jint h2;
  jint h3;
  jint h4;
  ...
  h3 = IOSShortArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable), h2 ^ IOSIntArray_Get(nil_chk(self->key3_), k)) ^ h1;
  h4 = IOSShortArray_Get(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable, h3 ^ IOSIntArray_Get(nil_chk(self->key2_), k)) ^ h2;
  h5 = IOSShortArray_Get(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable, h4 ^ IOSIntArray_Get(nil_chk(self->key1_), k)) ^ h3;
  h6 = IOSShortArray_Get(LibOrgBouncycastleCryptoEnginesSkipjackEngine_ftable, h5 ^ IOSIntArray_Get(nil_chk(self->key0_), k)) ^ h4;
  return ((JreLShift32(h6, 8)) + h5);
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesSkipjackEngine)
