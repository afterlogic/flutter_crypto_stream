...
@interface LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters ()

- (void)init__ OBJC_METHOD_FAMILY_NONE;

@end

__attribute__((unused)) static void LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_init__(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *self);

@implementation LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters
...
withLibOrgBouncycastleCryptoDigest:(id<LibOrgBouncycastleCryptoDigest>)hashAlg {
  LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withBoolean_withByteArray_withBoolean_withBoolean_withLibOrgBouncycastleCryptoDigest_(self, N, q, df, dm0, db, c, minCallsR, minCallsMask, hashSeed, oid, sparse, fastFp, hashAlg);
  return self;
}
...
- (instancetype)initWithInt:(jint)N
              ...
              withByteArray:(IOSByteArray *)oid
                ...
                withBoolean:(jboolean)fastFp
withLibOrgBouncycastleCryptoDigest:(id<LibOrgBouncycastleCryptoDigest>)hashAlg {
  LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withBoolean_withByteArray_withBoolean_withBoolean_withLibOrgBouncycastleCryptoDigest_(self, N, q, df1, df2, df3, dm0, db, c, minCallsR, minCallsMask, hashSeed, oid, sparse, fastFp, hashAlg);
  return self;
}

- (void)init__ {
  LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_init__(self);
}

- (instancetype)initWithJavaIoInputStream:(JavaIoInputStream *)is {
  LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithJavaIoInputStream_(self, is);
  return self;
}
...
- (jboolean)isEqual:(id)obj {
  ...
  LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *other = (LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *) cast_chk(obj, [LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters class]);
  if (N_ != other->N_) {
    return false;
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LLibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters;", 0x1, 5, -1, -1, -1, -1, -1 },
  ...
  static const void *ptrTable[] = { "IIIIIIIIZ[BZZLLibOrgBouncycastleCryptoDigest;", "IIIIIIIIIIZ[BZZLLibOrgBouncycastleCryptoDigest;", "init", "LJavaIoInputStream;", "LJavaIoIOException;", "clone", "writeTo", "LJavaIoOutputStream;", "hashCode", "equals", "LNSObject;", "toString" };
  static const J2ObjcClassInfo _LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters = { "NTRUEncryptionParameters", "lib.org.bouncycastle.pqc.crypto.ntru", ptrTable, methods, fields, 7, 0x1, 10, 27, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters;
}
...
LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *new_LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withBoolean_withByteArray_withBoolean_withBoolean_withLibOrgBouncycastleCryptoDigest_(jint N, jint q, jint df, jint dm0, jint db, jint c, jint minCallsR, jint minCallsMask, jboolean hashSeed, IOSByteArray *oid, jboolean sparse, jboolean fastFp, id<LibOrgBouncycastleCryptoDigest> hashAlg) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters, initWithInt_withInt_withInt_withInt_withInt_withInt_withInt_withInt_withBoolean_withByteArray_withBoolean_withBoolean_withLibOrgBouncycastleCryptoDigest_, N, q, df, dm0, db, c, minCallsR, minCallsMask, hashSeed, oid, sparse, fastFp, hashAlg)
}
...
void LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_init__(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *self) {
  self->dr_ = self->df_;
  self->dr1_ = self->df1_;
  self->dr2_ = self->df2_;
  self->dr3_ = self->df3_;
...
void LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithJavaIoInputStream_(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *self, JavaIoInputStream *is) {
  NSObject_init(self);
...
LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *new_LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithJavaIoInputStream_(JavaIoInputStream *is) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters, initWithJavaIoInputStream_, is)
}

LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters *create_LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters_initWithJavaIoInputStream_(JavaIoInputStream *is) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters, initWithJavaIoInputStream_, is)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastlePqcCryptoNtruNTRUEncryptionParameters)
