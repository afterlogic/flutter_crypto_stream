...
@interface LibOrgBouncycastleCryptoEnginesRC2Engine () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesRC2Engine, workingKey_, IOSIntArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesRC2Engine_get_piTable(void);
inline IOSByteArray *LibOrgBouncycastleCryptoEnginesRC2Engine_set_piTable(IOSByteArray *value);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesRC2Engine_piTable;
J2OBJC_STATIC_FIELD_OBJ(LibOrgBouncycastleCryptoEnginesRC2Engine, piTable, IOSByteArray *)

inline jint LibOrgBouncycastleCryptoEnginesRC2Engine_get_BLOCK_SIZE(void);
#define LibOrgBouncycastleCryptoEnginesRC2Engine_BLOCK_SIZE 8
J2OBJC_STATIC_FIELD_CONSTANT(LibOrgBouncycastleCryptoEnginesRC2Engine, BLOCK_SIZE, jint)

__attribute__((unused)) static IOSIntArray *LibOrgBouncycastleCryptoEnginesRC2Engine_generateWorkingKeyWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, IOSByteArray *key, jint bits);

__attribute__((unused)) static jint LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, jint x, jint y);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesRC2Engine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, IOSByteArray *inArg, jint inOff, IOSByteArray *outArg, jint outOff);

__attribute__((unused)) static void LibOrgBouncycastleCryptoEnginesRC2Engine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, IOSByteArray *inArg, jint inOff, IOSByteArray *outArg, jint outOff);

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesRC2Engine)

@implementation LibOrgBouncycastleCryptoEnginesRC2Engine

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastleCryptoEnginesRC2Engine_init(self);
  return self;
}
...
- (IOSIntArray *)generateWorkingKeyWithByteArray:(IOSByteArray *)key
                                         withInt:(jint)bits {
  return LibOrgBouncycastleCryptoEnginesRC2Engine_generateWorkingKeyWithByteArray_withInt_(self, key, bits);
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  ...
  if ([params isKindOfClass:[LibOrgBouncycastleCryptoParamsRC2Parameters class]]) {
    LibOrgBouncycastleCryptoParamsRC2Parameters *param = (LibOrgBouncycastleCryptoParamsRC2Parameters *) params;
    workingKey_ = LibOrgBouncycastleCryptoEnginesRC2Engine_generateWorkingKeyWithByteArray_withInt_(self, [((LibOrgBouncycastleCryptoParamsRC2Parameters *) nil_chk(param)) getKey], [param getEffectiveKeyBits]);
  }
    ...
    workingKey_ = LibOrgBouncycastleCryptoEnginesRC2Engine_generateWorkingKeyWithByteArray_withInt_(self, key, ((IOSByteArray *) nil_chk(key))->size_ * 8);
  }
  else {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"invalid parameter passed to RC2 init - ", [[((id<LibOrgBouncycastleCryptoCipherParameters>) nil_chk(params)) java_getClass] getName]));
  }
}
...
- (jint)getBlockSize {
  return LibOrgBouncycastleCryptoEnginesRC2Engine_BLOCK_SIZE;
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if ((inOff + LibOrgBouncycastleCryptoEnginesRC2Engine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(inArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if ((outOff + LibOrgBouncycastleCryptoEnginesRC2Engine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(outArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoOutputLengthException_initWithNSString_(@"output buffer too short");
  }
  if (encrypting_) {
    LibOrgBouncycastleCryptoEnginesRC2Engine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(self, inArg, inOff, outArg, outOff);
  }
  else {
    LibOrgBouncycastleCryptoEnginesRC2Engine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(self, inArg, inOff, outArg, outOff);
  }
  return LibOrgBouncycastleCryptoEnginesRC2Engine_BLOCK_SIZE;
}
...
- (jint)rotateWordLeftWithInt:(jint)x
                      withInt:(jint)y {
  return LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x, y);
}
...
IOSIntArray *LibOrgBouncycastleCryptoEnginesRC2Engine_generateWorkingKeyWithByteArray_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, IOSByteArray *key, jint bits) {
  ...
  if (len < 128) {
    ...
    do {
      x = IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesRC2Engine_piTable), (x + IOSIntArray_Get(xKey, index++)) & 255) & (jint) 0xff;
      *IOSIntArray_GetRef(xKey, len++) = x;
    }
    while (len < 128);
  }
  len = JreRShift32((bits + 7), 3);
  x = IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesRC2Engine_piTable), IOSIntArray_Get(xKey, 128 - len) & (JreRShift32(255, (7 & -bits)))) & (jint) 0xff;
  *IOSIntArray_GetRef(xKey, 128 - len) = x;
  for (jint i = 128 - len - 1; i >= 0; i--) {
    x = IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesRC2Engine_piTable, x ^ IOSIntArray_Get(xKey, i + len)) & (jint) 0xff;
...
jint LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, jint x, jint y) {
  x &= (jint) 0xffff;
  return (JreLShift32(x, y)) | (JreRShift32(x, (16 - y)));
}

void LibOrgBouncycastleCryptoEnginesRC2Engine_encryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, IOSByteArray *inArg, jint inOff, IOSByteArray *outArg, jint outOff) {
  jint x76;
  jint x54;
  jint x32;
  jint x10;
  ...
  for (jint i = 0; i <= 16; i += 4) {
    x10 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x10 + (x32 & ~x76) + (x54 & x76) + IOSIntArray_Get(nil_chk(self->workingKey_), i), 1);
    x32 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x32 + (x54 & ~x10) + (x76 & x10) + IOSIntArray_Get(nil_chk(self->workingKey_), i + 1), 2);
    x54 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x54 + (x76 & ~x32) + (x10 & x32) + IOSIntArray_Get(nil_chk(self->workingKey_), i + 2), 3);
    x76 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x76 + (x10 & ~x54) + (x32 & x54) + IOSIntArray_Get(nil_chk(self->workingKey_), i + 3), 5);
  }
...
void LibOrgBouncycastleCryptoEnginesRC2Engine_decryptBlockWithByteArray_withInt_withByteArray_withInt_(LibOrgBouncycastleCryptoEnginesRC2Engine *self, IOSByteArray *inArg, jint inOff, IOSByteArray *outArg, jint outOff) {
  jint x76;
  jint x54;
  jint x32;
  jint x10;
  ...
  for (jint i = 60; i >= 44; i -= 4) {
    x76 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x76, 11) - ((x10 & ~x54) + (x32 & x54) + IOSIntArray_Get(nil_chk(self->workingKey_), i + 3));
    x54 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x54, 13) - ((x76 & ~x32) + (x10 & x32) + IOSIntArray_Get(nil_chk(self->workingKey_), i + 2));
    x32 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x32, 14) - ((x54 & ~x10) + (x76 & x10) + IOSIntArray_Get(nil_chk(self->workingKey_), i + 1));
    x10 = LibOrgBouncycastleCryptoEnginesRC2Engine_rotateWordLeftWithInt_withInt_(self, x10, 15) - ((x32 & ~x76) + (x54 & x76) + IOSIntArray_Get(nil_chk(self->workingKey_), i));
  }
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesRC2Engine)
