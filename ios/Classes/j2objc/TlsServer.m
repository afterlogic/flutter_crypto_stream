...
@interface LibOrgBouncycastleCryptoTlsTlsServer : NSObject

@end

@implementation LibOrgBouncycastleCryptoTlsTlsServer
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LLibOrgBouncycastleCryptoTlsProtocolVersion;", 0x401, -1, -1, 4, -1, -1, -1 },
    ...
    { NULL, "LLibOrgBouncycastleCryptoTlsTlsCredentials;", 0x401, -1, -1, 4, -1, -1, -1 },
    { NULL, "LLibOrgBouncycastleCryptoTlsCertificateStatus;", 0x401, -1, -1, 4, -1, -1, -1 },
    { NULL, "LLibOrgBouncycastleCryptoTlsTlsKeyExchange;", 0x401, -1, -1, 4, -1, -1, -1 },
    { NULL, "LLibOrgBouncycastleCryptoTlsCertificateRequest;", 0x401, -1, -1, 4, -1, -1, -1 },
    { NULL, "V", 0x401, 13, 14, 4, -1, -1, -1 },
    { NULL, "V", 0x401, 15, 16, 4, -1, -1, -1 },
    { NULL, "LLibOrgBouncycastleCryptoTlsNewSessionTicket;", 0x401, -1, -1, 4, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  #pragma clang diagnostic ignored "-Wundeclared-selector"
  methods[0].selector = @selector(init__WithLibOrgBouncycastleCryptoTlsTlsServerContext:);
  methods[1].selector = @selector(notifyClientVersionWithLibOrgBouncycastleCryptoTlsProtocolVersion:);
  ...
  methods[16].selector = @selector(notifyClientCertificateWithLibOrgBouncycastleCryptoTlsCertificate:);
  methods[17].selector = @selector(getNewSessionTicket);
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "init", "LLibOrgBouncycastleCryptoTlsTlsServerContext;", "notifyClientVersion", "LLibOrgBouncycastleCryptoTlsProtocolVersion;", "LJavaIoIOException;", "notifyFallback", "Z", "notifyOfferedCipherSuites", "[I", "notifyOfferedCompressionMethods", "[S", "processClientExtensions", "LJavaUtilHashtable;", "processClientSupplementalData", "LJavaUtilVector;", "notifyClientCertificate", "LLibOrgBouncycastleCryptoTlsCertificate;" };
  static const J2ObjcClassInfo _LibOrgBouncycastleCryptoTlsTlsServer = { "TlsServer", "lib.org.bouncycastle.crypto.tls", ptrTable, methods, NULL, 7, 0x609, 18, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastleCryptoTlsTlsServer;
}

@end

J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoTlsTlsServer)
