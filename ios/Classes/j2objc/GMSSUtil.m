...
@implementation LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil_init(self);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil = { "GMSSUtil", "lib.org.bouncycastle.pqc.crypto.gmss.util", ptrTable, methods, NULL, 7, 0x1, 9, 0, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil;
}

@end

void LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil_init(LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil *self) {
  NSObject_init(self);
}

LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil *new_LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil, init)
}

LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil *create_LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastlePqcCryptoGmssUtilGMSSUtil)
