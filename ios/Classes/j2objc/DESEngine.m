...
@interface LibOrgBouncycastleCryptoEnginesDESEngine () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastleCryptoEnginesDESEngine, workingKey_, IOSIntArray *)

inline IOSShortArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_bytebit(void);
static IOSShortArray *LibOrgBouncycastleCryptoEnginesDESEngine_bytebit;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, bytebit, IOSShortArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_bigbyte(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_bigbyte;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, bigbyte, IOSIntArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_pc1(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesDESEngine_pc1;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, pc1, IOSByteArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_totrot(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesDESEngine_totrot;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, totrot, IOSByteArray *)

inline IOSByteArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_pc2(void);
static IOSByteArray *LibOrgBouncycastleCryptoEnginesDESEngine_pc2;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, pc2, IOSByteArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP1(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP1;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP1, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP2(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP2;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP2, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP3(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP3;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP3, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP4(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP4;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP4, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP5(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP5;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP5, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP6(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP6;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP6, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP7(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP7;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP7, IOSIntArray *)

inline IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_get_SP8(void);
static IOSIntArray *LibOrgBouncycastleCryptoEnginesDESEngine_SP8;
J2OBJC_STATIC_FIELD_OBJ_FINAL(LibOrgBouncycastleCryptoEnginesDESEngine, SP8, IOSIntArray *)

J2OBJC_INITIALIZED_DEFN(LibOrgBouncycastleCryptoEnginesDESEngine)

@implementation LibOrgBouncycastleCryptoEnginesDESEngine

+ (jint)BLOCK_SIZE {
  return LibOrgBouncycastleCryptoEnginesDESEngine_BLOCK_SIZE;
}
...
withLibOrgBouncycastleCryptoCipherParameters:(id<LibOrgBouncycastleCryptoCipherParameters>)params {
  if ([params isKindOfClass:[LibOrgBouncycastleCryptoParamsKeyParameter class]]) {
    if (((IOSByteArray *) nil_chk([((LibOrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((LibOrgBouncycastleCryptoParamsKeyParameter *) params))) getKey]))->size_ > 8) {
      @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"DES key too long - should be 8 bytes");
    }
    workingKey_ = [self generateWorkingKeyWithBoolean:encrypting withByteArray:[((LibOrgBouncycastleCryptoParamsKeyParameter *) nil_chk(((LibOrgBouncycastleCryptoParamsKeyParameter *) params))) getKey]];
    return;
  }
  @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$$", @"invalid parameter passed to DES init - ", [[((id<LibOrgBouncycastleCryptoCipherParameters>) nil_chk(params)) java_getClass] getName]));
}
...
- (jint)processBlockWithByteArray:(IOSByteArray *)inArg
  ...
  if ((inOff + LibOrgBouncycastleCryptoEnginesDESEngine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(inArg))->size_) {
    @throw new_LibOrgBouncycastleCryptoDataLengthException_initWithNSString_(@"input buffer too short");
  }
  if ((outOff + LibOrgBouncycastleCryptoEnginesDESEngine_BLOCK_SIZE) > ((IOSByteArray *) nil_chk(outArg))->size_) {
...
- (IOSIntArray *)generateWorkingKeyWithBoolean:(jboolean)encrypting
  ...
  for (jint j = 0; j < 56; j++) {
    jint l = IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_pc1), j);
    *IOSBooleanArray_GetRef(pc1m, j) = ((IOSByteArray_Get(nil_chk(key), JreURShift32(l, 3)) & IOSShortArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_bytebit), l & 07)) != 0);
  }
  for (jint i = 0; i < 16; i++) {
    jint l;
    jint m;
    ...
    *IOSIntArray_GetRef(newKey, m) = *IOSIntArray_GetRef(newKey, n) = 0;
    for (jint j = 0; j < 28; j++) {
      l = j + IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_totrot), i);
      if (l < 28) {
    ...
    for (jint j = 0; j < 24; j++) {
      if (IOSBooleanArray_Get(pcr, IOSByteArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_pc2), j))) {
        *IOSIntArray_GetRef(newKey, m) |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_bigbyte), j);
      }
      if (IOSBooleanArray_Get(pcr, IOSByteArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_pc2, j + 24))) {
        *IOSIntArray_GetRef(newKey, n) |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_bigbyte), j);
      }
    }
  }
...
- (void)desFuncWithIntArray:(IOSIntArray *)wKey
  ...
  jint right;
  jint left;
  left = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(inArg, inOff);
  right = LibOrgBouncycastleUtilPack_bigEndianToIntWithByteArray_withInt_(inArg, inOff + 4);
  ...
  for (jint round = 0; round < 8; round++) {
    ...
    fval = IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP7), work & (jint) 0x3f);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP5), (JreURShift32(work, 8)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP3), (JreURShift32(work, 16)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP1), (JreURShift32(work, 24)) & (jint) 0x3f);
    work = right ^ IOSIntArray_Get(wKey, round * 4 + 1);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP8), work & (jint) 0x3f);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP6), (JreURShift32(work, 8)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP4), (JreURShift32(work, 16)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(nil_chk(LibOrgBouncycastleCryptoEnginesDESEngine_SP2), (JreURShift32(work, 24)) & (jint) 0x3f);
    left ^= fval;
    work = (JreLShift32(left, 28)) | (JreURShift32(left, 4));
    work ^= IOSIntArray_Get(wKey, round * 4 + 2);
    fval = IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP7, work & (jint) 0x3f);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP5, (JreURShift32(work, 8)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP3, (JreURShift32(work, 16)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP1, (JreURShift32(work, 24)) & (jint) 0x3f);
    work = left ^ IOSIntArray_Get(wKey, round * 4 + 3);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP8, work & (jint) 0x3f);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP6, (JreURShift32(work, 8)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP4, (JreURShift32(work, 16)) & (jint) 0x3f);
    fval |= IOSIntArray_Get(LibOrgBouncycastleCryptoEnginesDESEngine_SP2, (JreURShift32(work, 24)) & (jint) 0x3f);
    right ^= fval;
  }
  ...
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(right, outArg, outOff);
  LibOrgBouncycastleUtilPack_intToBigEndianWithInt_withByteArray_withInt_(left, outArg, outOff + 4);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "BLOCK_SIZE", "I", .constantValue.asInt = LibOrgBouncycastleCryptoEnginesDESEngine_BLOCK_SIZE, 0x1c, -1, -1, -1, -1 },
...
+ (void)initialize {
  if (self == [LibOrgBouncycastleCryptoEnginesDESEngine class]) {
    ...
    J2OBJC_SET_INITIALIZED(LibOrgBouncycastleCryptoEnginesDESEngine)
  }
}

@end

void LibOrgBouncycastleCryptoEnginesDESEngine_init(LibOrgBouncycastleCryptoEnginesDESEngine *self) {
  NSObject_init(self);
  self->workingKey_ = nil;
}

LibOrgBouncycastleCryptoEnginesDESEngine *new_LibOrgBouncycastleCryptoEnginesDESEngine_init() {
  J2OBJC_NEW_IMPL(LibOrgBouncycastleCryptoEnginesDESEngine, init)
}

LibOrgBouncycastleCryptoEnginesDESEngine *create_LibOrgBouncycastleCryptoEnginesDESEngine_init() {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastleCryptoEnginesDESEngine, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastleCryptoEnginesDESEngine)
