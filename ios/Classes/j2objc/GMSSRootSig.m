...
@interface LibOrgBouncycastlePqcCryptoGmssGMSSRootSig () {
 @public
...
J2OBJC_FIELD_SETTER(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, messDigestOTS_, id<LibOrgBouncycastleCryptoDigest>)
J2OBJC_FIELD_SETTER(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, privateKeyOTS_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, hash__, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, sign_, IOSByteArray *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, gmssRandom_, LibOrgBouncycastlePqcCryptoGmssUtilGMSSRandom *)
J2OBJC_FIELD_SETTER(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, seed_, IOSByteArray *)

__attribute__((unused)) static void LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_oneStep(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *self);

@implementation LibOrgBouncycastlePqcCryptoGmssGMSSRootSig
...
- (instancetype)initWithLibOrgBouncycastleCryptoDigest:(id<LibOrgBouncycastleCryptoDigest>)digest
  ...
  LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withByteArray2_withIntArray_(self, digest, statByte, statInt);
  return self;
}
...
- (instancetype)initWithLibOrgBouncycastleCryptoDigest:(id<LibOrgBouncycastleCryptoDigest>)digest
                                               withInt:(jint)w
                                               withInt:(jint)height {
  LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withInt_withInt_(self, digest, w, height);
  return self;
}
...
- (void)initSignWithByteArray:(IOSByteArray *)seed0
  ...
  self->hash__ = [IOSByteArray newArrayWithLength:[((id<LibOrgBouncycastleCryptoDigest>) nil_chk(messDigestOTS_)) getDigestSize]];
  [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(messDigestOTS_)) doFinalWithByteArray:self->hash__ withInt:0];
...
- (jboolean)updateSign {
  for (jint s = 0; s < steps_; s++) {
    if (counter_ < keysize_) {
      LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_oneStep(self);
    }
    if (counter_ == keysize_) {
      return true;
    }
...
- (NSString *)description {
  ...
  for (jint i = 0; i < 5; i++) {
    out = JreStrcat("$$C", out, [NSString java_stringWithBytes:LibOrgBouncycastleUtilEncodersHex_encodeWithByteArray_(IOSObjectArray_Get(nil_chk(statByte), i))], ' ');
  }
  return out;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LLibOrgBouncycastleCryptoDigest;[[B[I", "LLibOrgBouncycastleCryptoDigest;II", "initSign", "[B[B", "getLog", "I", "toString", "hash" };
  static const J2ObjcClassInfo _LibOrgBouncycastlePqcCryptoGmssGMSSRootSig = { "GMSSRootSig", "lib.org.bouncycastle.pqc.crypto.gmss", ptrTable, methods, fields, 7, 0x1, 11, 20, -1, -1, -1, -1, -1 };
  return &_LibOrgBouncycastlePqcCryptoGmssGMSSRootSig;
}

@end

void LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withByteArray2_withIntArray_(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *self, id<LibOrgBouncycastleCryptoDigest> digest, IOSObjectArray *statByte, IOSIntArray *statInt) {
  NSObject_init(self);
...
LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *new_LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withByteArray2_withIntArray_(id<LibOrgBouncycastleCryptoDigest> digest, IOSObjectArray *statByte, IOSIntArray *statInt) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, initWithLibOrgBouncycastleCryptoDigest_withByteArray2_withIntArray_, digest, statByte, statInt)
}

LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *create_LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withByteArray2_withIntArray_(id<LibOrgBouncycastleCryptoDigest> digest, IOSObjectArray *statByte, IOSIntArray *statInt) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, initWithLibOrgBouncycastleCryptoDigest_withByteArray2_withIntArray_, digest, statByte, statInt)
}

void LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withInt_withInt_(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *self, id<LibOrgBouncycastleCryptoDigest> digest, jint w, jint height) {
  NSObject_init(self);
  self->messDigestOTS_ = digest;
  self->gmssRandom_ = new_LibOrgBouncycastlePqcCryptoGmssUtilGMSSRandom_initWithLibOrgBouncycastleCryptoDigest_(self->messDigestOTS_);
  self->mdsize_ = [((id<LibOrgBouncycastleCryptoDigest>) nil_chk(self->messDigestOTS_)) getDigestSize];
...
LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *new_LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withInt_withInt_(id<LibOrgBouncycastleCryptoDigest> digest, jint w, jint height) {
  J2OBJC_NEW_IMPL(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, initWithLibOrgBouncycastleCryptoDigest_withInt_withInt_, digest, w, height)
}

LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *create_LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_initWithLibOrgBouncycastleCryptoDigest_withInt_withInt_(id<LibOrgBouncycastleCryptoDigest> digest, jint w, jint height) {
  J2OBJC_CREATE_IMPL(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig, initWithLibOrgBouncycastleCryptoDigest_withInt_withInt_, digest, w, height)
}

void LibOrgBouncycastlePqcCryptoGmssGMSSRootSig_oneStep(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig *self) {
  if (8 % self->w_ == 0) {
    if (self->test_ == 0) {
      ...
      self->privateKeyOTS_ = [IOSByteArray newArrayWithLength:[((id<LibOrgBouncycastleCryptoDigest>) nil_chk(self->messDigestOTS_)) getDigestSize]];
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(LibOrgBouncycastlePqcCryptoGmssGMSSRootSig)
